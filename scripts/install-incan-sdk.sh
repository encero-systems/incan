...
default_manifest_url="https://incan.pub/releases/latest/manifest.json"
...
Options:
  --manifest <URL|PATH>   Release manifest to use (default: https://incan.pub/releases/latest/manifest.json)
