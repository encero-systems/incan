...
///
/// This historical source-catalog record does not select a graph. The physical loader consumes generated sources
/// only when they are explicitly present in a validated selected projection.
...
/// Historical package/version-to-output catalog retained for artifact compatibility.
///
/// These records describe existing outputs only. They do not select units or enable build-script execution;
/// inspection reads generated sources only through an explicit selected projection.
