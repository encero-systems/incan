...
pub use metadata::{
    ...
    RustModuleInfo, RustParam, RustTraitAssoc, RustTraitInfo, RustTypeInfo, RustTypeShape, RustVariantInfo,
    RustVisibility, metadata_free_method_signature, render_rust_type_shape, render_rust_type_shape_path,
