...
use crate::oven::rustc::{
    ...
    OvenRustcArtifactManifest, OvenRustcArtifactPlan, OvenRustcError, OvenRustcRegistrySourcePackage,
...
fn packaged_provider_candidates<'a>(
...
mod tests {
    ...
    use crate::oven::plan::OvenPackagedProviderExecutionPlan;
