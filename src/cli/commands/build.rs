...
use crate::backend::selection::{BackendKind, resolve_execution, select_backend};
use crate::cli::commands::build_report::{emit_build_report, emit_rust_inspection_report, emit_workspace_build_report};
use crate::cli::{CliError, CliResult, ExitCode};
use crate::driver::build::backend_selection::{default_backend_receipt_path, write_backend_receipt};
use crate::driver::build::bake::{bake_oven_library, bake_oven_project, select_default_executable_project_output};
use crate::driver::build::inline_command::{inline_command_project, wrap_inline_command_source};
...
use crate::driver::build::output_paths::{normalized_project_entrypoint, project_root_for_completed_output};
use crate::driver::build::oven_project::prepare_oven_project;
use crate::driver::build::plan_authority::explicit_bake_profiles;
use crate::driver::build::replacement::{build_replacement_file_report, reject_normal_cargo_controls};
use crate::driver::build::rust_extern::{RustExternBuildFailureKind, RustExternDeclContext};
...
use crate::oven::rustc::clear_inherited_cargo_environment;
...
mod tests {
    use super::*;
    use crate::driver::build::test_support::undesugared_vocab_declaration;
    use std::path::{Path, PathBuf};
    use std::{env, fs};

    use crate::backend::selection::{BackendKind, FallbackPolicy};
    use crate::driver::build::library_exports::collect_library_rust_abi;
    use crate::driver::build::library_outputs::write_library_manifest_artifacts;
    use crate::driver::build::library_project::prepare_library_project;
    use crate::driver::build::rust_extern::{RustExternBuildFailureKind, RustExternDeclContext};
    use crate::driver::build::{BackendSelectionOptions, BuildCommandOptions, OvenProjectPlanMode};
    use crate::driver::build_report::BuildReportOptions;
    use crate::driver::cargo_policy::CargoPolicy;
    use crate::driver::error::{CliError, ExitCode};
    use crate::frontend::api_metadata::ApiDeclaration;
    use crate::frontend::ast::{Declaration, Span};
    use crate::frontend::{body_ir, lexer, parser};
