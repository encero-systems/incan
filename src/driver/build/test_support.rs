...
use crate::driver::build::publication::project_output_payload_for_bake;
...
use crate::frontend::ast::{Declaration, Span, Spanned};
...
use crate::oven::rustc::{OvenProjectInspectionAuthorityRef, resolve_active_rustc, rustc_host_target, rustc_identity};
...
pub(crate) fn fixture_project_output_publication(
    project_root: &Path,
    profile: &str,
    label: &str,
) -> Result<
...
pub(crate) fn fixture_project_output_publication_for(
    project_root: &Path,
    profile: &str,
    label: &str,
...
pub(crate) fn packaged_provider_authority_fixture(
    profiles: &[&str],
...
pub(crate) fn replacement_build_options() -> BuildCommandOptions {
    BuildCommandOptions {
...
pub(crate) fn undesugared_vocab_declaration() -> Spanned<Declaration> {
    Spanned::new(
