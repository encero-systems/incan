...
use crate::driver::build::package_loafs::{
    read_packaged_library_loaf_manifest, validated_packaged_library_loaf_profile,
};
use crate::driver::build::source_authority::project_bake_receipt_path;
use crate::driver::build::{OvenBakeProjectTarget, OvenProjectBakeAuthorityContext};
...
use crate::oven::rustc::{OvenCallerOwnedRustcLibrary, OvenRustcArtifactManifest, OvenRustcArtifactPlan};
...
pub(crate) fn append_oven_interop_execution_build_inputs(
    ...
    let locked = crate::driver::interop_plan::locked_interop_plan_target(manifest.project_root(), target)?;
...
pub(crate) fn first_unselected_private_provider_edge<'a>(
...
pub(crate) fn caller_owned_library_dependencies_without_public_provider_edges(
...
pub(crate) fn deduplicate_caller_owned_libraries_prefer_extern(libraries: &mut Vec<OvenCallerOwnedRustcLibrary>) {
...
pub(crate) fn load_receipted_public_provider_dependency(
...
pub(crate) fn caller_owned_library_receipt(
...
pub(crate) fn caller_owned_library_edition(artifact: &LibraryArtifactMetadata) -> CliResult<String> {
...
pub(crate) fn caller_owned_library_is_proc_macro(artifact: &LibraryArtifactMetadata) -> CliResult<bool> {
...
pub(crate) fn caller_owned_library_rust_dependencies(
    artifact: &LibraryArtifactMetadata,
...
mod tests {
    ...
    use crate::frontend::library_manifest_index::{LibraryArtifactKind, LibraryArtifactMetadata};
    use crate::library_manifest::{LibraryManifest, ProviderDependencyKind, ProviderDependencyMetadata};
    use crate::lockfile::{CargoFeatureSelection, IncanLock, LockedOvenState, SemanticLockState};
    use crate::manifest::{DependencySource, DependencySpec, ProjectManifest};
    use crate::oven::interop::{
    ...
    use crate::oven::rustc::{OvenCallerOwnedRustcLibrary, OvenRustcArtifactPlan};
