...
use crate::driver::build::caller_owned::{
...
use crate::driver::build::plan_selection::{registry_leaf_authority_for_plan_selection, select_published_project_plan};
...
use crate::driver::build::{OvenBakeProjectTarget, OvenProjectBakeAuthorityContext, OvenToolchainMaterialization};
use crate::driver::error::{CliError, CliResult, oven_plan_error, oven_rustc_error};
use crate::frontend::library_manifest_index::{LibraryArtifactKind, LibraryArtifactMetadata, dependency_project_root};
use crate::library_manifest::{LibraryManifest, ProviderDependencyKind, digest_provider_artifact};
use crate::manifest::{DependencySource, DependencySpec};
use crate::oven::plan::composition::provider_compilation_artifacts;
...
pub(crate) fn compiler_owned_roots_with_provider_plan(
...
pub(crate) fn is_selected_compiler_runtime_path_dependency(
...
/// `-L dependency=...` search.
#[derive(Default)]
pub(crate) struct CallerOwnedProviderRegistryClosure {
    pub(crate) provider_authorities: Vec<OvenRegistryLeafAuthority>,
...
impl CallerOwnedProviderRegistryClosure {
    ...
    pub(crate) fn merged_authority(
        &self,
        consumer: Option<OvenRegistryLeafAuthority>,
...
pub(crate) fn collect_caller_owned_provider_registry_leaf_authority(
    store: &OvenStore,
...
pub(crate) fn read_verified_caller_owned_provider_receipt(
    project_root: &Path,
    profile: &str,
) -> Option<crate::oven::OvenReceipt> {
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn rematerialize_caller_owned_libraries_with_authority_context(
    provider_plan: &ProviderPlan,
    profile: &str,
    artifacts: &OvenRustcArtifactManifest,
    artifact_root: &Path,
...
pub(crate) fn replace_selected_package_library_externs(
...
pub(crate) fn oven_source_inline_dependency_specs(
...
pub(crate) fn declared_rust_libraries_missing_from_selected_plan_with_current_project_paths(
    dependencies: &[DependencySpec],
    artifact_plan: &OvenRustcArtifactPlan,
...
pub(crate) fn validate_selected_plan_registry_dependencies(
    dependencies: &[DependencySpec],
...
pub(crate) fn explicit_bake_profiles() -> Vec<&'static str> {
...
mod tests {
    ...
    use crate::oven::rustc::{OvenRegistryLeafAuthority, OvenRustcArtifactPlan};
