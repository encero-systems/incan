...
use crate::driver::build::output_paths::{
    validate_packaged_library_metadata_files, validated_project_output_relative_path,
};
use crate::driver::build::source_authority::digest_baked_project_source_authority;
...
use crate::oven::plan::{OvenDirectRustcPlanSelection, OvenPackagedLibraryLoafEntry};
...
pub(crate) fn export_selected_package_loaf(
...
pub(crate) fn copy_receipted_oven_store_entry(
    source_store: &OvenStore,
...
pub(crate) fn write_packaged_library_loaf_manifest(
    artifact_root: &Path,
...
pub(crate) fn decode_packaged_library_loaf_manifest(
...
pub(crate) fn read_packaged_library_loaf_manifest(
    artifact: &LibraryArtifactMetadata,
...
pub(crate) fn validated_packaged_library_loaf_profile(
    artifact: &LibraryArtifactMetadata,
    manifest: &OvenPackagedLibraryLoafManifest,
    profile: &str,
    target: &str,
...
pub(crate) fn import_checked_packaged_library_loaf(
...
mod tests {
    ...
    use crate::driver::build::caller_owned::caller_owned_library_receipt;
    use crate::driver::build::library_outputs::packaged_library_loaf_store_root;
    ...
    use crate::oven::plan::test_support::{package_loaf_manifest, recapture_package_loaf_closure};
    use crate::oven::plan::{
