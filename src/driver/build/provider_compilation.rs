...
use crate::driver::build::caller_owned::caller_owned_library_rust_dependencies;
#[cfg(test)]
...
use crate::driver::build::oven_project::project_extension_base_loaf;
...
use crate::driver::build::plan_authority::is_selected_compiler_runtime_path_dependency;
use crate::driver::build::{CheckedPackagedProviderProfile, OvenProjectBakeAuthorityContext, OvenProjectPlanMode};
...
use crate::oven::legacy_cargo::{OVEN_PROVIDER_COMPILATION_KEY, OvenCompilerMacroDependency};
use crate::oven::plan::selection::SelectedPackagedProviderPlans;
use crate::oven::rustc::{OvenRustcArtifactManifest, OvenRustcArtifactPlan, trusted_artifact_plan_for_source_evidence};
...
pub(crate) fn plan_with_provider_compilation_role(
...
pub(crate) fn caller_owned_library_dependencies_for_compilation(
...
pub(crate) fn checked_provider_compilation_requirements(
...
pub(crate) fn checked_packaged_provider_profiles(
...
pub(crate) fn checked_test_dependency_package_profiles(
...
pub(crate) fn import_packaged_provider_loafs_for_explicit_bake(
...
pub(crate) fn caller_owned_library_dependencies_missing_from_selected_plan_with_owned_roots(
    dependencies: &[DependencySpec],
...
mod tests {
    ...
    use crate::driver::error::oven_plan_error;
    ...
    use crate::manifest::{DependencySource, DependencySpec};
    use crate::oven::legacy_cargo::OVEN_PROVIDER_COMPILATION_KEY;
