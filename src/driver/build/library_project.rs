...
use crate::driver::build::library_exports::{
...
use crate::driver::build::provider_metadata::{
    collect_unprojected_provider_modules, compiled_provider_metadata, synchronize_projected_provider_dependencies,
};
use crate::driver::build::rust_extern::{
    collect_rust_extern_contexts, multi_file_output_identity, rust_extern_report_paths,
};
...
use crate::driver::lock::resolution::{resolve_lock_context, validate_oven_lock_policy};
#[cfg(feature = "rust_inspect")]
use crate::driver::lock::rust_inspect::prepare_rust_inspect_workspace;
use crate::driver::lock::{LockResolution, LockResolutionRequest};
...
use crate::frontend::library_exports::{CheckedNamedExport, checked_exports_by_name, collect_checked_public_exports};
...
use crate::oven::legacy_cargo::provider_compilation_requirements_digest;
use crate::oven::loaf::{
...
use crate::provider::{FeatureSelection, SDK_PROVIDER_BUILD_ENV};
#[cfg(feature = "rust_inspect")]
...
pub(crate) fn prepare_library_project(
