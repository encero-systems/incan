...
use crate::driver::build::rust_extern::RustExternDeclContext;
...
use crate::frontend::library_exports::{CheckedExportKind, CheckedNamedExport, LibraryExportBindingRegistry};
...
pub(crate) fn collect_library_rust_abi(
...
pub(crate) fn resolve_library_project_root(file_path: Option<&str>) -> CliResult<PathBuf> {
...
pub(crate) fn validate_library_entrypoint(manifest: &ProjectManifest) -> CliResult<PathBuf> {
...
pub(crate) fn module_key(path_segments: &[String]) -> String {
...
pub(crate) fn public_ordinal_type_identities(
...
pub(crate) struct LibraryReexportResolver<'a> {
    pub(crate) module_exports: &'a HashMap<String, HashMap<String, Vec<CheckedNamedExport>>>,
}
...
impl<'a> LibraryReexportResolver<'a> {
    ...
    pub(crate) fn new(module_exports: &'a HashMap<String, HashMap<String, Vec<CheckedNamedExport>>>) -> Self {
        Self { module_exports }
    }
    ...
    pub(crate) fn direct_public_exports(lib_module: &ParsedModule) -> Vec<(String, crate::frontend::ast::Span)> {
        lib_module
            .ast
            .declarations
            .iter()
...
mod tests {
    ...
    use crate::driver::build::rust_extern::collect_rust_extern_contexts;
