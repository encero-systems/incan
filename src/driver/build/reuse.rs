...
use crate::driver::build::library_outputs::{library_publication_receipts, packaged_library_loaf_store_root};
...
use crate::driver::build::output_selection::{
    baked_project_owner_identity, select_baked_project_output_with_source_authority,
};
...
pub(crate) fn try_reuse_baked_project(
    project_root: &Path,
...
impl OvenProjectBakeAuthorityContext {
    ...
    pub(crate) fn checked_packaged_library_loaf_profiles(
        &mut self,
    ...
    pub(crate) fn cache_probe_source_authority(&self, project_root: &Path) -> CliResult<String> {
    ...
    pub(crate) fn lock_published(&mut self) {
    ...
    pub(crate) fn project_source_authority(&mut self, project_root: &Path) -> CliResult<String> {
    ...
    pub(crate) fn final_project_source_authority(&self, project_root: &Path) -> CliResult<String> {
