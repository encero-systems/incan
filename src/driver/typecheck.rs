...
pub(crate) struct TypecheckModuleArtifacts {
    pub(crate) type_infos: Vec<TypeCheckInfo>,
    pub(crate) stdlib_cache: StdlibAstCache,
...
pub(crate) fn typecheck_modules_with_import_graph_artifacts(
    modules: &[ParsedModule],
    manifest: Option<&ProjectManifest>,
    provider_plan: &Arc<ProviderPlan>,
    c_abi_plan: Option<&CAbiVerificationPlan>,
