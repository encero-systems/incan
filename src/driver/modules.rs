...
use crate::driver::diagnostics::{CliDiagnosticFailure, render_module_warnings};
use crate::driver::error::{CliError, CliResult};
use crate::driver::project::{
    collect_incan_source_files, read_source_for_diagnostics, resolve_stdlib_module_source_path,
};
...
use crate::frontend::{ast_walk, diagnostics, typechecker};
use crate::manifest::ProjectManifest;
use crate::provider::inventory::sdk_provider_bootstrap_namespace_roots;
use crate::provider::{FeatureSelection, ProviderModuleResolution, ProviderPlan, SDK_PROVIDER_BUILD_ENV};
