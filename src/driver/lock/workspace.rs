...
use crate::driver::lock::test_inputs::collect_test_lock_inputs;
use crate::driver::lock::{ProjectLockContext, TestLockInputs, WorkspaceLockCollection, WorkspaceLockMemberFailure};
#[cfg(test)]
...
use crate::lockfile::{CargoFeatureSelection, semantic_lock_state, workspace_semantic_lock_state};
...
pub(crate) fn collect_workspace_lock_context(
...
pub(crate) fn collect_workspace_lock_context_tolerating(
    workspace: &WorkspaceGraph,
    command_root: &Path,
    entry_file: Option<&Path>,
    cargo_features: &CargoFeatureSelection,
...
pub(crate) fn collect_project_lock_context(
...
mod tests {
    use super::*;
    use crate::driver::lock::test_support::registry_dependency;
