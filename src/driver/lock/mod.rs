...
#[cfg(test)]
#[allow(dead_code)]
pub(crate) const LOCK_DEPENDENCY_PREHEAT_STALE_LOCK_SECS: u64 = 30 * 60;

#[cfg(test)]
#[allow(dead_code)]
pub(crate) const LIBRARY_DEPENDENCY_PREHEAT_FINGERPRINT_FILE: &str = ".incan_library_dependency_preheat_fingerprint";

#[cfg(test)]
#[allow(dead_code)]
pub(crate) const LIBRARY_DEPENDENCY_PREHEAT_LOCK_FILE: &str = ".incan_library_dependency_preheat.lock";
...
#[cfg(test)]
pub(crate) fn record_project_lock_context_collection() {
...
#[cfg(test)]
pub(crate) fn record_project_lock_session_discovery() {
    update_project_lock_collection_metrics(|metrics| {
...
#[cfg(test)]
pub(crate) fn record_project_lock_authority_snapshot_read() {
    update_project_lock_collection_metrics(|metrics| {
...
#[cfg(test)]
pub(crate) fn record_project_lock_provider_plan_projection() {
    update_project_lock_collection_metrics(|metrics| {
...
#[cfg(test)]
#[allow(dead_code)]
pub(crate) struct DependencyPreheatContext<'a> {
    project_name: &'a str,
...
pub(crate) struct WorkspaceLockResolutionRequest<'a> {
...
pub(crate) struct ProjectLockContext {
...
pub(crate) enum ProviderBakeLockPublication {
...
pub(crate) struct WorkspaceLockMemberFailure {
    error: CliError,
}

/// A workspace lock collection together with the members it had to leave out.
pub(crate) struct WorkspaceLockCollection {
    context: ProjectLockContext,
...
pub(crate) struct TestLockInputs {
...
#[cfg(test)]
#[allow(dead_code)]
pub(crate) struct LockDependencyPreheatGuard {
    path: PathBuf,
}
...
pub(crate) const INERT_CARGO_LOCK_PAYLOAD: &str = "version = 4\n";
