...
use crate::driver::lock::workspace::{
...
pub(crate) fn collect_and_publish_project_lock(
...
mod tests {
    use super::*;
    use crate::driver::lock::test_support::{empty_project_requirements, empty_resolved};
