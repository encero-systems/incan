...
pub(crate) fn compiler_suite_target_from_unit(
    compiler_root: &Path,
    receipt: &OvenReceipt,
...
pub(crate) fn compiler_suite_verified_target_source_bytes(
    compiler_root: &Path,
    receipt: &OvenReceipt,
...
pub(crate) fn compiler_suite_workspace_library_from_unit(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    unit: &CargoUnitGraphUnit,
    graph: &CargoUnitGraph,
...
pub(crate) fn compiler_suite_workspace_libraries_for_roots(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    graph: &CargoUnitGraph,
    root_indices: &[usize],
...
pub(crate) fn compiler_suite_binary_dependencies(
    unit: &CargoUnitGraphUnit,
    graph: &CargoUnitGraph,
    compiler_root: &Path,
...
pub(crate) fn compiler_suite_target_kind(kinds: &[String]) -> Result<String, OvenLegacyCargoError> {
...
pub(crate) fn compiler_suite_target_runner(mode: &str) -> Result<String, OvenLegacyCargoError> {
    match mode {
...
pub(crate) fn workspace_package_value(compiler_root: &Path, field: &str) -> Option<String> {
...
#[cfg(test)]
pub(crate) fn compiler_suite_target_plan_coverage(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    graph: &CargoUnitGraph,
    artifact_index: &BTreeMap<CargoUnitArtifactKey, Vec<PathBuf>>,
...
pub(crate) fn compiler_suite_direct_target_plan(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    staging: &Path,
    target: &Path,
...
#[cfg(test)]
pub(crate) fn compiler_suite_direct_cli_plan(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    staging: &Path,
    target: &Path,
...
#[cfg(test)]
pub(crate) fn compiler_suite_cli_target_from_catalog(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    cli_graph: &CargoUnitGraph,
    cli_outputs: &[CargoInvocationOutput],
...
pub(crate) fn compiler_suite_cli_target_from_artifact_index(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    cli_graph: &CargoUnitGraph,
    artifact_index: &BTreeMap<CargoUnitArtifactKey, Vec<PathBuf>>,
...
#[cfg(test)]
pub(crate) fn compiler_suite_direct_target_shard_plan(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    staging: &Path,
    target: &Path,
...
pub(crate) fn compiler_suite_direct_target_shard_from_catalog(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    graph: &CargoUnitGraph,
    root_index: usize,
...
#[cfg(test)]
pub(crate) fn compiler_suite_binary_targets(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    graph: &CargoUnitGraph,
    artifact_index: &BTreeMap<CargoUnitArtifactKey, Vec<PathBuf>>,
...
pub(crate) fn compiler_suite_binary_targets_for_roots(
    compiler_root: &Path,
    receipt: &OvenReceipt,
    graph: &CargoUnitGraph,
    root_indices: &[usize],
...
pub(crate) fn compiler_suite_unit_is_in_workspace(
    compiler_root: &Path,
    unit: &CargoUnitGraphUnit,
