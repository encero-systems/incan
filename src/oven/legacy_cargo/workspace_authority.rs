...
pub(crate) struct LocalCargoWorkspaceAuthority {
    root: PathBuf,
...
pub(crate) struct EffectiveLocalCargoDependency {
    alias: String,
...
pub(crate) fn locked_local_package(
    manifest_path: &Path,
    manifest: &toml::Value,
    lock: &mut toml::Value,
...
pub(crate) fn local_cargo_workspace_authority(
    manifest_path: &Path,
    manifest: &toml::Value,
...
pub(crate) fn read_local_cargo_workspace_manifest(
    manifest_path: &Path,
...
pub(crate) fn read_local_cargo_manifest(
    manifest_path: &Path,
) -> Result<LocalCargoWorkspaceAuthority, OvenLegacyCargoError> {
...
pub(crate) fn inherited_workspace_package_version(
...
pub(crate) fn detached_compiler_package_version(
    lock: &toml::Value,
    name: &str,
    manifest_path: &Path,
) -> Result<String, OvenLegacyCargoError> {
...
pub(crate) fn manifest_dependency_entries(
    manifest_path: &Path,
    manifest: &toml::Value,
...
pub(crate) fn collect_manifest_dependency_entries(
    manifest_path: &Path,
    manifest_root: &Path,
...
pub(crate) fn merged_workspace_dependency_specification(
    alias: &str,
...
pub(crate) fn merge_workspace_dependency_features(
    alias: &str,
...
pub(crate) fn locked_manifest_dependency(
    manifest_root: &Path,
    alias: &str,
    specification: &toml::Value,
    lock: &mut toml::Value,
