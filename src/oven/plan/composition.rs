...
pub(crate) fn retain_packaged_provider_fragment_dependency_search_paths<'a>(
...
pub(crate) fn provider_compilation_artifacts(
...
pub(crate) fn compose_selected_packaged_provider_plan(
...
pub(crate) fn compose_packaged_provider_plan(
...
pub(crate) fn compose_direct_packaged_provider_plan(
...
pub(crate) fn merge_packaged_provider_artifact_manifests_with_release_base(
...
pub(crate) fn merge_packaged_provider_artifact_manifests(
...
mod tests {
    ...
    use super::*;
    use crate::oven::rustc::{direct_rustc_source_extern_names, trusted_artifact_plan_for_source_evidence};
