...
use crate::oven::legacy_cargo::{OVEN_PROJECT_EXTENSION_PAYLOAD_SCHEMA_VERSION, OvenProjectExtensionPayload};
...
use crate::oven::store::{OvenArtifactKind, OvenStore, OvenStoreExecutionPayload};
...
pub(crate) fn select_packaged_direct_rustc_execution_plan(
    store: &OvenStore,
    receipt: &OvenReceipt,
...
pub(crate) fn select_receipt_project_extension_execution_plan(
    store: &OvenStore,
    receipt: &OvenReceipt,
...
pub(crate) fn project_extension_execution_plan_from_selected(
