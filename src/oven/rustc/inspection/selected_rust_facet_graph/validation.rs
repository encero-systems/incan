...
pub(super) fn selected_graph_missing(field: impl Into<String>) -> OvenSelectedRustFacetGraphError {
...
pub(super) fn selected_graph_invalid(
...
pub(super) fn validate_selected_graph_text(value: &str, field: &str) -> Result<(), OvenSelectedRustFacetGraphError> {
    if value.is_empty() {
...
pub(super) fn validate_selected_graph_digest(value: &str, field: &str) -> Result<(), OvenSelectedRustFacetGraphError> {
    if value.is_empty() {
        return Err(selected_graph_missing(field));
    }
...
pub(super) fn validate_selected_graph_path(
    value: &str,
    field: &str,
...
pub(super) fn validate_selected_graph_source_identity(
...
pub(super) fn validate_selected_graph_alias(value: &str, field: &str) -> Result<(), OvenSelectedRustFacetGraphError> {
    validate_selected_graph_text(value, field)?;
...
pub(super) fn validate_selected_graph_sorted_strings(
    values: &[String],
    field: &str,
) -> Result<(), OvenSelectedRustFacetGraphError> {
    for value in values {
...
pub(super) fn canonicalize_selected_graph(graph: &mut OvenSelectedRustFacetGraph) {
...
pub(super) fn validate_selected_graph_owner_reference(
    owner: &str,
...
pub(super) fn validate_selected_graph_path_reference(
...
pub(super) fn validate_selected_graph_environment(
    name: &str,
