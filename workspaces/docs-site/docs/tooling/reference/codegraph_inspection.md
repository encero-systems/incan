...
```json
{"kind":"module_level"}
{"kind":"nested","owner":{"namespace":"value","origin":{"kind":"module","path":["main"]},"declaration_name":"outer","declaration_kind":"function","location":{"kind":"module_level"},"signature":"() -> None"},"binding_ordinal":0}
```
