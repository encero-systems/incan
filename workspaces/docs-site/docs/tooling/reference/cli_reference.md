...
Reports local CLI and LSP executable locations and editor path settings.
...
JSON output contains the same executable and editor fields. The report does not assess project dependency availability.
