...
- **Target scope:** v0.6, slice 7 (Oven CLI delivery, #1142); brought into scope 2026-09-10. Table root is `[envs]` per RFC 117.
- **Shipped in:** —
