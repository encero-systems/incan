...
| --- | --- | --- | --- |
| `stdlib-core` | `std.prelude`, `std.result`, `std.traits.*`, `std.derives.*`, `std.this`, `std.reflection`, `std.registry`, and the source-owned capability catalog | — | mandatory, `minimal`, `default`, `full` |
