...
naming usability, latency, and library typing gaps as pain points: [Typed Python in 2024](https://engineering.fb.com/2024/12/09/developer-tools/typed-python-2024-survey-meta/).
