...
If you’re new to Incan, start here.
...
- **Understand the fit**: [What Incan is for](what_incan_is_for.md)
...
- **Evaluate the 1.0 direction**: [1.0 domain-native demo target](domain_native_demo.md) + [1.0 public contracts](public_contracts.md)
...
- [1.0 public contracts](public_contracts.md)
