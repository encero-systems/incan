...
- **Codegraph**: An Incan-authored external importer experiment validates schema-v1 JSONL exports end to end while keeping compiler-owned facts authoritative and unknown future record kinds opaque (RFC 106, #776).
