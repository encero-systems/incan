...
- **Compiler/Codegen**: Normal generated Rust no longer emits the blanket crate-level `#![allow(unused_imports, dead_code, unused_variables)]`. The backend now omits unused prelude/derive imports, qualifies generated stdlib and derive paths directly, keeps any remaining generated warning allowances scoped to the relevant item/import, and uses `--emit-rust --strict` to emit crate-level denies for validation (#214).
