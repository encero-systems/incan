...
[Callable objects](../language/reference/stdlib_traits/callable.md), [RFC 059](../RFCs/059_std_regex.md).
...
- `std.regex` regular expressions, captures, splitting, and replacement: [RFC 059](../RFCs/059_std_regex.md)
