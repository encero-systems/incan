...
The formatter also preserves docstring payload spacing, keeps abstract trait methods tight until a following default/body-bearing method, treats stand-alone comments as leading or trailing bundles rather than allowing comments to satisfy blank-line quotas on their own, and clamps ordinary code to no more than two consecutive blank lines.
