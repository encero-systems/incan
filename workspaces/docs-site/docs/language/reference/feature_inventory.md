...
| Build and test preheat observability | Tooling | 0.4 | Use verbose test output, `--generated-cargo-target-dir`, or `INCAN_RUST_INSPECT_TIMING=1` when build/test warm-cache behavior needs to be inspected or shared. | `incan test -v tests`<br>`incan build --lib --generated-cargo-target-dir target/generated-cargo`<br>`INCAN_RUST_INSPECT_TIMING=1 incan build --lib` | Build and test preheat paths report phase timing, Cargo target reuse, Rust metadata warmed/reused/skipped counts, vocab companion cache reuse, and cache split reasons. | Silent long-running preheat phases, hidden generated target directories, or separate probes that do not share the real build/test cache policy. | [CLI reference](../../tooling/reference/cli_reference.md), [Release 0.4](../../release_notes/0_4.md) |
...
The toolchain install path is manifest-driven, checksum-verified, and installs `incan` plus `incan-lsp` from the same release archives across direct and package-manager channels.
...
- **RFC:** `RFC 015`
- **Stability:** `Stable`
- **Activation:** Use verbose test output, `--generated-cargo-target-dir`, or `INCAN_RUST_INSPECT_TIMING=1` when build/test warm-cache behavior needs to be inspected or shared.
- **Use instead of:** Silent long-running preheat phases, hidden generated target directories, or separate probes that do not share the real build/test cache policy.
- **References:** [CLI reference](../../tooling/reference/cli_reference.md), [Release 0.4](../../release_notes/0_4.md)
...
- `incan test -v tests`
- `incan build --lib --generated-cargo-target-dir target/generated-cargo`
