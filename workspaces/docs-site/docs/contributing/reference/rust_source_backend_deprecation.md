...
| The frozen emission tree | `scripts/check_emitter_freeze.py` and `loaves/compiler/incan_emit/tests/fixtures/emitter_freeze/manifest.json`; see [Emitter freeze](emitter_freeze.md). |
