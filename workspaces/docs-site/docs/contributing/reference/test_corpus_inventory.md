...
| `loaves/kernel/incan_syntax/src/diagnostics/stable.rs` | 8 | 911 | 240 | keep | - | - | - | #1561 | checker 8 | lexer, parser and diagnostics catalog; below the emitter, cannot reach codegen. Reviewed at crate level. |
