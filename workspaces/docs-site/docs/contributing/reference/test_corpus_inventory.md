...
- Retire-class tests: 1120, of which twinned 47, dies 115, open 958 (neither yet).
...
### `loaves/compiler/incan_frontend` (1730 tests in 83 files: keep 1730)
...
### `loaves/compiler/incan_ir` (156 tests in 13 files: keep 1, retire 155)
...
| `loaves/kernel/incan_syntax/src/diagnostics/stable.rs` | 6 | 745 | 167 | keep | - | - | - | #1561 | checker 6 | lexer, parser and diagnostics catalog; below the emitter, cannot reach codegen. Reviewed at crate level. |
...
### `loaves/toolchain/incan-cli` (633 tests in 44 files: keep 117, re-point 357, retire 34, unaffected 125)
...
| `loaves/toolchain/incan-cli/tests/behavior_snapshots_tests.rs` | 6 | 49 | 49 | re-point | - | - | - | #1561 | - | runs every behaviour fixture of the snapshots_* areas (one libtest case per leaf area) as a program and compares its observables; the route changes under it, the fixtures do not. |
