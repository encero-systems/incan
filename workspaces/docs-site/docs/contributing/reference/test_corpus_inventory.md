...
| `loaves/toolchain/incan-cli/tests/behavior_snapshots_tests.rs` | 7 | 55 | 55 | re-point | - | - | - | #1561 | - | runs every behaviour fixture of the snapshots_* areas (one libtest case per leaf area) as a program and compares its observables; the route changes under it, the fixtures do not. |
