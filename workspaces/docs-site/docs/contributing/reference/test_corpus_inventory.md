...
- Retire-class tests: 1130, of which twinned 60, dies 116, open 954 (neither yet).
...
### `loaves/compiler/incan_frontend` (1763 tests in 85 files: keep 1763)

| File | Tests | Lines | Test lines | Disposition | Twins | Dies | Split | Owner | Signals | Notes |
|---|---:|---:|---:|---|---:|---:|---|---|---|---|
| `loaves/compiler/incan_frontend/src/api_metadata.rs` | 17 | 3763 | 944 | keep | - | - | - | #1561 | checker 17, parser 17 | typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. Reviewed at crate level; generated-text hits are Incan source or diagnostics. |
...
| `loaves/compiler/incan_frontend/src/library_manifest/tests/export_round_trips.rs` | 22 | 1092 | 1092 | keep | - | - | - | #1561 | checker 20 | split of library_manifest/tests.rs; typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. |
...
| `loaves/compiler/incan_frontend/src/resolved_type_subst.rs` | 1 | 219 | 46 | keep | - | - | - | #1561 | - | typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. Reviewed at crate level; generated-text hits are Incan source or diagnostics. |
...
| `loaves/compiler/incan_frontend/src/symbols.rs` | 16 | 3057 | 462 | keep | - | - | - | #1561 | checker 10 | typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. Reviewed at crate level; generated-text hits are Incan source or diagnostics. |
...
| `loaves/compiler/incan_frontend/src/typechecker/collect/stdlib_imports.rs` | 1 | 4833 | 32 | keep | - | - | - | #1561 | checker 1 | typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. Reviewed at crate level; generated-text hits are Incan source or diagnostics. |
...
| `loaves/compiler/incan_frontend/src/typechecker/stdlib_loader.rs` | 31 | 3076 | 1113 | keep | - | - | - | #1561 | parser 30 | typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. Reviewed at crate level; generated-text hits are Incan source or diagnostics. |
...
| `loaves/compiler/incan_frontend/src/typechecker/tests/pub_imports_trait_adoptions.rs` | 8 | 705 | 705 | keep | - | - | - | #1561 | checker 8, parser 2 | split of typechecker/tests.rs; typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. |
...
| `loaves/compiler/incan_ir/src/lower/decl/helpers.rs` | 3 | 989 | 150 | retire | 0/3 | 0 | - | #1561 | legacy_ir 3 | the Rust-source backend's own lowering (`AstLowering`, `IrProgram`, `IrType`, Rust name spellings). Retire because its only consumers are `incan_emit` and the driver's `backend/ir` re-export, and `replacement/**` and `shadow/**` import nothing from it; flips to keep if #654 keeps the generated-project inspection path or the keep definition is read to include this lowering. Twins belong in Body IR (loaves/compiler/incan_frontend/src/body_ir/tests/). Reviewed at crate level. |
...
| `loaves/kernel/incan_syntax/src/diagnostics/stable.rs` | 8 | 982 | 269 | keep | - | - | - | #1561 | checker 8 | lexer, parser and diagnostics catalog; below the emitter, cannot reach codegen. Reviewed at crate level. |
