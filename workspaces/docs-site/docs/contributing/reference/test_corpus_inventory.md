...
| `loaves/compiler/incan_emit/src/tests/tuple_assignment_emission.rs` | 6 | 253 | 253 | retire (retire 6) | 6/6 | 0 | - | #1561 | codegen 6, text 1, parser 6 | asserts the generated Rust text of multi-target assignments that write existing places (#1798, #1799, #1806); retires with the Rust-source backend. |
...
| `loaves/compiler/incan_ir/src/lower/tests/tuple_assignment.rs` | 6 | 546 | 546 | retire (retire 6) | 6/6 | 0 | - | #1561 | legacy_ir 6 | the Rust-source backend's own lowering of multi-target assignments into existing places (#1798, #1799, #1806); retires with `incan_ir`. Twins belong in Body IR (loaves/compiler/incan_frontend/src/body_ir/tests/). |
