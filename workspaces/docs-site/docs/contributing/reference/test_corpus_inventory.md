...
- Retire-class tests: 1124, of which twinned 57, dies 115, open 952 (neither yet).
...
| `loaves/compiler/incan_frontend/src/typechecker/tests/calls_decorators_and_builtins.rs` | 55 | 1329 | 1329 | keep | - | - | - | #1561 | checker 31, parser 9 | split of typechecker/tests.rs; typechecker, Body IR, library manifests, provider plans; no emit/driver dependency. |
...
### `loaves/compiler/incan_ir` (162 tests in 15 files: keep 1, retire 161)
...
| `loaves/kernel/incan_syntax/src/diagnostics/stable.rs` | 8 | 948 | 265 | keep | - | - | - | #1561 | checker 8 | lexer, parser and diagnostics catalog; below the emitter, cannot reach codegen. Reviewed at crate level. |
