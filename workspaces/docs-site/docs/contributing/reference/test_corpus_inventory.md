...
| re-point | 485 | 47 | 401 |
| retire | 1109 | 72 | 0 |
| unaffected | 1425 | 133 | 5 |
| unreviewed | 0 | 0 | 0 |
| **Total** | **6129** | **441** | **413** |

- Retire-class tests: 1109, of which twinned 30, dies 118, open 961 (neither yet).
...
### `loaves/toolchain/incan-cli` (622 tests in 43 files: keep 117, re-point 347, retire 35, unaffected 123)
