...
| [#806](https://github.com/encero-systems/incan/issues/806) | Closed by PR #807: receiver-side generic constructor turbofish was accepted and emitted incorrectly. | Rust associated-call planning and receiver type identity. | Keep as 0.5 interop inventory evidence; future diagnostic-policy work should reject unsupported method call-site type arguments explicitly. |
