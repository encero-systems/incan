def slices:
  [
    ...
    { number: 4, issue_number: 1141, slug: "oven-authority-native-rust", title: "Oven authority and native Rust", focus: "Loaf authority, direct-rustc planning, and bounded Rust facets.", proof: "Incan-only, Rust-only, and mixed Loaves bake without Cargo being authoritative.", exit_evidence: "Rust-only, Incan-only, and mixed Loaves bake without Cargo being the project authority; Cargo remains valid as explicit compatibility/adoption mode." },
    { number: 5, issue_number: 1478, slug: "workspace-layout-rewrite", title: "Workspace layout rewrite, five rings under loaves/", focus: "Kernel, compiler, Oven, stdlib and toolchain rings with an Incan-free Oven ring.", proof: "The Oven ring depends on no Incan ring, incan-lsp builds without the CLI, and every ring carries its own version line.", exit_evidence: "the root crate is split along the four import knots into ring crates under loaves/; the Oven ring checks in a tree with no compiler crates; paths, tests and CI follow the rings; incan_core is renamed incan_lang last." },
    { number: 6, issue_number: 1561, slug: "loaf-native-ecosystem", title: "Loaf-native ecosystem, build scripts inert", focus: "Manifest-declared package needs; no build-script execution.", proof: "Every dependency in the corpus bakes from its manifest alone, byte-equivalent to its Cargo build.", exit_evidence: "a build.rs anywhere in a bake produces one warning and nothing else; every package in incan's and IncQL's resolved graphs bakes under Oven from a loaf.toml with no Cargo invocation; adoption writes those manifests from an existing Cargo build." },
    { number: 7, issue_number: 1142, slug: "oven-cli-delivery", title: "Oven CLI delivery", focus: "Shared Oven planning for build and bake.", proof: "One plan and receipt model; neither CLI gains a competing planner.", exit_evidence: "one installation, two non-competing CLIs, one Loaf authority, and one plan/receipt model." },
    { number: 8, issue_number: 1143, slug: "first-class-inspectability", title: "First-class inspectability", focus: "Shared compiler, package, artifact, and Rust/Oven inspection facts.", proof: "CLI, LSP, Architect, MCP, and Rust inspection agree on identity and provenance.", exit_evidence: "CLI, LSP, Architect, MCP, and Rust inspection agree on identity, range, provenance, and stale-state semantics." },
    { number: 9, issue_number: 1139, slug: "canonical-source-meaning", title: "Canonical source meaning", focus: "One source identity across compiler, tools, and backend facts.", proof: "Aliases, imports, locals, members, and binders resolve consistently.", exit_evidence: "aliases, imports, re-exports, locals, members, and generic binders resolve to one identity across compiler, LSP, graph, and backend facts." },
    { number: 10, issue_number: 1379, slug: "native-windows", title: "Native Windows support", focus: "A Windows host that builds, bakes, and ships like the others.", proof: "A packaged Windows toolchain builds and runs a project, not merely a bake that exits zero.", exit_evidence: "the release bake produces a Windows archive; that archive, extracted and installed, scaffolds a project and builds it; platform-gated behavior is implemented or its divergence is stated in code and docs." },
    { number: 11, issue_number: 1144, slug: "cutover-release", title: "Cutover and release", focus: "Corpus-led compatibility reporting and normal-path removal.", proof: "The complete matrix is green or explicitly migrated before generated Rust loses authority.", exit_evidence: "generated Rust is an inspection/debug projection only; normal compilation, package contracts, and Oven no longer depend on it as semantic authority." },
    { number: 12, issue_number: 1421, slug: "incan-authored-control-plane", title: "Incan-authored control plane and governed runtime", focus: "Incan-authored Oven components and the RFC 104 authority model.", proof: "Components migrate only behind a bridge that exists, and declared authority matches observed receipts.", exit_evidence: "every semantic Oven responsibility with an Incan-authored owner is authored in Incan through a typed, governed host kernel; no migrated component relies on an undocumented bridge; declared authority and observed receipts describe the same run and stay inspectable without executing source or parsing logs." }
  ];
