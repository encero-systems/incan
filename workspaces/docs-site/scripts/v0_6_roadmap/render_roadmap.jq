def slices:
  [
    ...
    { number: 5, issue_number: 1561, slug: "loaf-native-ecosystem", title: "Loaf-native ecosystem, build scripts inert", focus: "Manifest-declared package needs; no build-script execution.", proof: "Every dependency in the corpus bakes from its manifest alone, byte-equivalent to its Cargo build.", exit_evidence: "a build.rs anywhere in a bake produces one warning and nothing else; every package in incan's and IncQL's resolved graphs bakes under Oven from a loaf.toml with no Cargo invocation; adoption writes those manifests from an existing Cargo build." },
    { number: 6, issue_number: 1142, slug: "oven-cli-delivery", title: "Oven CLI delivery", focus: "Shared Oven planning for build and bake.", proof: "One plan and receipt model; neither CLI gains a competing planner.", exit_evidence: "one installation, two non-competing CLIs, one Loaf authority, and one plan/receipt model." },
    { number: 7, issue_number: 1143, slug: "first-class-inspectability", title: "First-class inspectability", focus: "Shared compiler, package, artifact, and Rust/Oven inspection facts.", proof: "CLI, LSP, Architect, MCP, and Rust inspection agree on identity and provenance.", exit_evidence: "CLI, LSP, Architect, MCP, and Rust inspection agree on identity, range, provenance, and stale-state semantics." },
    { number: 8, issue_number: 1139, slug: "canonical-source-meaning", title: "Canonical source meaning", focus: "One source identity across compiler, tools, and backend facts.", proof: "Aliases, imports, locals, members, and binders resolve consistently.", exit_evidence: "aliases, imports, re-exports, locals, members, and generic binders resolve to one identity across compiler, LSP, graph, and backend facts." },
