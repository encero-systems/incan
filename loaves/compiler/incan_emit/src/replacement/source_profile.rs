...
use incan_frontend::ast::{Declaration, ImportKind, Visibility};
use incan_frontend::body_ir::{
...
fn is_local_module_import(import: &incan_frontend::ast::ImportDecl) -> bool {
...
fn interop_boundary_description(import: &incan_frontend::ast::ImportDecl) -> Option<String> {
...
#[must_use]
pub fn source_profile_refusal(program: &incan_frontend::ast::Program) -> Option<ReplacementExecutionError> {
...
mod tests {
    ...
    fn program(source: &str) -> incan_frontend::ast::Program {
