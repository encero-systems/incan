...
pub struct ProviderExecutionRecord {
    ...
    pub receipt: crate::selection::BackendExecutionReceipt,
...
impl ProviderRuntime {
    ...
    pub fn resolves(&self, operation: &CanonicalSymbolId) -> bool {
...
pub fn canonical_provider_execution_summary(records: &[ProviderExecutionRecord]) -> String {
    records
        .iter()
        .map(|record| {
