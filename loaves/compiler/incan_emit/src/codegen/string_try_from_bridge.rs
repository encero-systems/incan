...
pub fn imports_std_string_try_from_contract(program: &Program) -> bool {
...
pub fn compilation_imports_std_string_try_from_contract(
    main: &Program,
...
#[derive(Debug, Clone)]
pub struct StringTryFromBridgeConfig {
    pub emit_local_newtype_impls: bool,
}

impl StringTryFromBridgeConfig {
    /// Build a bridge configuration for generated internal modules.
    pub fn for_internal_module(uses_contract: bool) -> Self {
        Self {
    ...
    pub fn for_crate_root(uses_contract: bool) -> Self {
        if !uses_contract {
