...
use incan_ir::decl::{IrEnumValue, IrEnumValueType};

/// Return whether a program imports the stdlib ordinal-map contract.
pub fn imports_std_ordinal_contract(program: &Program) -> bool {
...
pub fn compilation_imports_std_ordinal_contract(
    main: &Program,
...
fn export_adopts_ordinal_key(
    trait_adoptions: &[incan_frontend::library_manifest::TypeBoundExport],
    traits: &HashMap<String, &incan_frontend::library_manifest::TraitExport>,
) -> bool {
...
fn export_methods_include(methods: &[incan_frontend::library_manifest::MethodExport], name: &str) -> bool {
    methods
        .iter()
...
fn external_ordinal_custom_key(
    ...
    trait_adoptions: &[incan_frontend::library_manifest::TypeBoundExport],
    methods: &[incan_frontend::library_manifest::MethodExport],
    traits: &HashMap<String, &incan_frontend::library_manifest::TraitExport>,
...
#[derive(Debug, Clone)]
pub struct OrdinalBridgeConfig {
    pub emit_std_ordinal_value_enum_impls: bool,
    pub external_value_enums: Vec<ExternalOrdinalValueEnum>,
    pub external_custom_keys: Vec<ExternalOrdinalCustomKey>,
}

impl OrdinalBridgeConfig {
    /// Build a bridge configuration for generated internal modules.
    pub fn for_internal_module(uses_std_ordinal_contract: bool) -> Self {
        Self {
    ...
    pub fn for_crate_root(uses_std_ordinal_contract: bool, index: Option<&LibraryManifestIndex>) -> Self {
