...
pub fn list_index_assignment_element_type(object_ty: &IrType) -> Option<&IrType> {
    match object_ty {
...
fn determine_external_inferred_generic_arg_conversion(expr: &IrExpr, target_ty: Option<&IrType>) -> OwnershipPlan {
    ...
    match &expr.kind {
        IrExprKind::String(_) | IrExprKind::Literal(incan_ir::expr::Literal::StaticStr(_)) => OwnershipPlan::None,
