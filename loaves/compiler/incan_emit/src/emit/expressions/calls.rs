...
impl<'a> IrEmitter<'a> {
    ...
    pub fn is_unresolved_type(ty: &IrType) -> bool {
        match ty {
            IrType::Unknown => true,
    ...
    pub(in crate::emit) fn is_unresolved_call_seed_type(ty: &IrType) -> bool {
        match ty {
    ...
    pub fn emit_union_payload_arg_for_site(
        &self,
        arg: &TypedExpr,
        target_ty: &IrType,
        union_qualifier: Option<&[String]>,
    ...
    pub fn emit_inference_seeded_literal_arg_with_union_qualifier(
        &self,
        arg: &TypedExpr,
        target_ty: &IrType,
        union_qualifier: Option<&[String]>,
    ...
    fn emit_call_expr_with_result_use(
        ...
        if matches!(callee_name, Some(name) if name == INTERNAL_PANIC_FN)
            ...
            && matches!(
                &args[0].expr.kind,
                incan_ir::expr::IrExprKind::Literal(incan_ir::expr::Literal::StaticStr(_))
            )
        {
...
mod tests {
    ...
    fn contextual_union_payload_uses_checked_nominal_identity() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let target = IrType::ExternalUnion {
            ...
            native: Some(incan_ir::types::CarriedNativeUnion(Box::new(NativeUnionExport {
                ...
                checked_projection: Some(Box::new(incan_frontend::library_manifest::NativeUnionProjection {
