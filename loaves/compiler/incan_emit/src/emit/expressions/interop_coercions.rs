...
use crate::ownership::{is_byte_buffer_type, is_string_buffer_type};
use incan_ir::expr::{IrExprKind, Literal as IrLiteral, TypedExpr};
use incan_ir::types::IrType;

/// Emit a typechecker-selected Rust borrow coercion without re-planning ownership at the call site.
pub fn emit_builtin_borrow_coercion(
