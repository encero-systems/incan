...
pub(in crate::emit) fn method_kind_uses_mutable_receiver(kind: &MethodKind) -> bool {
    matches!(
        kind,
...
pub(in crate::emit) fn method_dispatch_uses_mutable_receiver(dispatch: Option<&IrMethodDispatch>) -> bool {
    matches!(
        dispatch,
...
pub(in crate::emit) fn method_name_uses_mutable_receiver(name: &str) -> bool {
...
impl<'a> IrEmitter<'a> {
    ...
    pub(in crate::emit) fn emit_incan_iterator_source(
        &self,
        iterable: &TypedExpr,
    ...
    pub fn tuple_field_expr(expr: &TypedExpr, idx: usize, ty: IrType) -> TypedExpr {
        TypedExpr::new(
            IrExprKind::Field {
    ...
    pub fn emit_expr_for_use(&self, expr: &TypedExpr, site: ValueUseSite<'_>) -> Result<TokenStream, EmitError> {
    ...
    pub fn emit_expr_for_use_with_union_qualifier(
        &self,
        expr: &TypedExpr,
        site: ValueUseSite<'_>,
        target_union_qualifier: Option<&[String]>,
    ...
    pub fn expr_is_type_like(expr: &TypedExpr) -> bool {
        match &expr.kind {
    ...
    /// Whether an assignable expression bottoms out in a source static or local binding.
    pub fn expr_is_storage_rooted(expr: &TypedExpr) -> bool {
    ...
    pub fn rewrite_storage_root_expr(expr: &TypedExpr, local_name: &str) -> TypedExpr {
    ...
    pub fn rewrite_storage_root_expr_for_mut(expr: &TypedExpr, local_name: &str) -> TypedExpr {
        ...
        let replacement = || {
            ...
            TypedExpr::new(
                IrExprKind::Var {
                    ...
                    access: incan_ir::expr::VarAccess::Read,
    ...
    pub fn emit_expr(&self, expr: &TypedExpr) -> Result<TokenStream, EmitError> {
        match &expr.kind {
    ...
    fn source_trait_take_dispatch_preserves_incan_int_argument() -> Result<(), String> {
        ...
        let expr = TypedExpr::new(
            IrExprKind::MethodCall {
                ...
                dispatch: Some(IrMethodDispatch::Trait(Box::new(incan_ir::expr::IrTraitDispatch {
                    trait_source_name: "FallibleIterator".to_string(),
                    trait_module_path: Some(vec!["std".to_string(), "derives".to_string(), "collection".to_string()]),
