...
pub(in crate::lower) fn callable_docstring(body: &[Spanned<ast::Statement>]) -> Option<String> {
...
impl AstLowering {
    ...
    pub(in crate::lower) fn decorator_original_function_name(name: &str) -> String {
    ...
    pub(in crate::lower) fn decorator_original_function_registry_key(name: &str) -> String {
    ...
    pub(in crate::lower) fn decorator_original_physical_name_for_key(key: &str) -> Option<String> {
    ...
    pub(in crate::lower) fn decorator_static_binding_name(name: &str) -> String {
    ...
    pub(in crate::lower) fn decorator_synthetic_callee_span() -> ast::Span {
        ast::Span::default()
    }

    /// Build an expression that resolves a decorator's path through ordinary expression lowering.
    pub(in crate::lower) fn decorator_path_expr(decorator: &ast::Decorator, span: ast::Span) -> Spanned<Expr> {
    ...
    pub(in crate::lower) fn decorator_path_expr_from_import_path(path: &ImportPath, span: ast::Span) -> Spanned<Expr> {
    ...
    pub(in crate::lower) fn decorator_callable_expr(
    ...
    pub(in crate::lower) fn decorator_call_args(
        decorator: &Spanned<ast::Decorator>,
