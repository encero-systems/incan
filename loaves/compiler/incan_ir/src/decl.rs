...
pub fn is_projected_source_symbol(identity: &CanonicalSymbolId) -> bool {
    matches!(
        identity.kind,
...
pub struct FunctionParam {
    ...
    pub kind: incan_frontend::ast::ParamKind,
...
impl Visibility {
    /// The Rust visibility keyword this visibility emits as, empty for private items.
