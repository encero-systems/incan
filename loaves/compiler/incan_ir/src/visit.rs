...
pub fn walk_stmt<V: Visitor + ?Sized>(stmt: &mut IrStmt, visitor: &mut V) {
    match &mut stmt.kind {
...
pub fn walk_expr<V: Visitor + ?Sized>(expr: &mut IrExpr, visitor: &mut V) {
    match &mut expr.kind {
...
pub fn walk_pattern<V: Visitor + ?Sized>(pattern: &mut Pattern, visitor: &mut V) {
    match pattern {
