...
impl FunctionRegistry {
    /// An empty registry with no functions recorded.
    pub fn new() -> Self {
        Self::default()
    }
    ...
    pub fn canonical_identity_for_source_name(&self, source_name: &str) -> Option<&CanonicalSymbolId> {
...
pub struct IrNewtypeConstructionPlan {
    ...
    pub constraints: Vec<incan_frontend::symbols::NewtypePrimitiveConstraint>,
...
pub enum IrCheckedCType {
    ...
    Resource {
        ...
        access: incan_frontend::typechecker::CResourceAccess,
    ...
    Output {
        ...
        mode: incan_frontend::typechecker::COutputMode,
