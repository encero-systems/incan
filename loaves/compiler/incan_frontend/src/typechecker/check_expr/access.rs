...
struct MethodCandidate {
    info: MethodInfo,
    dispatch: Option<crate::typechecker::ResolvedMethodDispatch>,
}
...
impl TypeChecker {
    ...
    /// only as `obj.type_`.
    pub(in crate::typechecker::check_expr) fn rust_field_for_source_name<'a>(
    ...
    ) -> crate::typechecker::ResolvedMethodDispatch {
    ...
    pub(in crate::typechecker) fn resolve_nominal_field_type(
        &mut self,
        type_name: &str,
        type_args: Option<&[ResolvedType]>,
        field: &str,
    ...
    pub(in crate::typechecker::check_expr) fn receiver_has_computed_property(
        &mut self,
    ...
    pub(in crate::typechecker) fn is_copy_type(&self, ty: &ResolvedType) -> bool {
        matches!(
            ty,
            ResolvedType::Never
                | ResolvedType::Int
    ...
    fn method_dispatch_substituting_call_site_self(
        &self,
        dispatch: crate::typechecker::ResolvedMethodDispatch,
    ...
    pub(in crate::typechecker::check_expr) fn method_types_substituting_call_site_self(
        &self,
    ...
    pub(in crate::typechecker) fn resolve_named_method(
        &mut self,
    ...
    pub(in crate::typechecker) fn resolve_generic_placeholder_method(
        &mut self,
        placeholder_name: &str,
        method: &str,
        explicit_type_args: &[Spanned<Type>],
    ...
    /// narrower subtraits.
    #[allow(clippy::too_many_arguments)]
    pub(in crate::typechecker) fn resolve_trait_receiver_method(
        &mut self,
        receiver_ty: &ResolvedType,
        method: &str,
        receiver_surface: MemberBindingSurface,
    ...
    pub(in crate::typechecker::check_expr) fn check_index(
        &mut self,
        base: &Spanned<Expr>,
        index: &Spanned<Expr>,
        span: Span,
    ...
    pub(in crate::typechecker::check_expr) fn check_slice(
        &mut self,
        base: &Spanned<Expr>,
        slice: &SliceExpr,
        _span: Span,
    ...
    pub(in crate::typechecker::check_expr) fn check_field(
        &mut self,
        base: &Spanned<Expr>,
        field: &str,
        span: Span,
    ...
    pub(in crate::typechecker::check_expr) fn check_method_call(
        &mut self,
        base: &Spanned<Expr>,
        method: &str,
        type_args: &[Spanned<Type>],
    ...
    pub(in crate::typechecker::check_expr) fn check_method_call_with_expected(
        &mut self,
        base: &Spanned<Expr>,
        method: &str,
        type_args: &[Spanned<Type>],
        ...
        if let Some(result) = self.check_c_abi_span_constructor(base, method, type_args, args, span) {
            return result;
        }
        ...
        if let Some(result) = self.check_c_abi_span_method(base, method, type_args, args, span) {
            return result;
        }
        if let Some(result) = self.check_c_abi_c_string_pointer(base, method, type_args, args, span) {
            return result;
        }
        if let Some(result) = self.check_c_abi_scoped_c_string_copy(base, method, type_args, args, span) {
            return result;
        }
