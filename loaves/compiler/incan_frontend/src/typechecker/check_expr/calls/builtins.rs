...
impl TypeChecker {
    ...
    pub(in crate::typechecker::check_expr) fn explicit_builtin_member_name(callee: &Spanned<Expr>) -> Option<&str> {
    ...
    pub(in crate::typechecker::check_expr) fn check_explicit_builtin_call(
        &mut self,
        name: &str,
        args: &[CallArg],
        call_span: Span,
    ...
    pub(in crate::typechecker::check_expr) fn validate_stdlib_module_function_call(
        &mut self,
        callable: &str,
        info: &FunctionInfo,
    ...
    pub(in crate::typechecker::check_expr::calls) fn check_builtin_call(
        &mut self,
        name: &str,
        args: &[CallArg],
        call_span: Span,
