...
impl TypeChecker {
    ...
    pub(in crate::typechecker::check_expr) fn check_call(
        &mut self,
        callee: &Spanned<Expr>,
    ...
    /// type is known.
    pub(in crate::typechecker::check_expr) fn check_call_with_expected(
        &mut self,
        callee: &Spanned<Expr>,
        type_args: &[Spanned<Type>],
        args: &[CallArg],
    ...
    pub(in crate::typechecker::check_expr) fn check_c_binding_symbol_member_call(
        &mut self,
        base: &Spanned<Expr>,
        member: &str,
        type_args: &[Spanned<Type>],
        ...
        if let Some(owner) = self.current_c_abi_raw_call_owner.as_ref()
            && owner.visibility == crate::ast::Visibility::Public
    ...
    fn validate_c_raw_output_slots(
        ...
        binding: &str,
        symbol: &CBindingSymbol,
        resources: &[crate::typechecker::CBindingResource],
        args: &[CallArg],
    ...
    /// nominal identity.
    pub(in crate::typechecker::check_expr) fn check_public_module_type_constructor_call(
        &mut self,
    ...
    pub(in crate::typechecker::check_expr) fn validate_function_overload_call_with_callee_span(
        &mut self,
        func_name: &str,
        overloads: &[FunctionOverloadInfo],
        type_args: &[Spanned<Type>],
