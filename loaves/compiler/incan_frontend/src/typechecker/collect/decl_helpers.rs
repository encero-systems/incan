        ...
        .map(|f| {
            ...
            (
                ...
                FieldInfo {
                    ...
                    surface_type_name: Some(crate::symbols::field_surface_type_name(&f.node.ty.node, &ty)),
                    ty,
                    visibility: f.node.visibility,
                    is_type_private: crate::symbols::field_is_type_private(&f.node, private_fields_are_type_private),
