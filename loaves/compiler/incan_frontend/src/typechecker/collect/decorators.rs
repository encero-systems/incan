...
pub(in crate::typechecker) fn resolve_decorator_path(dec: &Decorator, symbols: &SymbolTable) -> Vec<String> {
    decorator_resolution::resolve_decorator_path(dec, symbols)
}

/// Resolve a decorator path to a decorator id.
pub(in crate::typechecker) fn resolve_decorator_id(dec: &Decorator, symbols: &SymbolTable) -> Option<DecoratorId> {
...
impl TypeChecker {
    ...
    pub fn validate_decorators_allowing_user_defined(&mut self, decorators: &[Spanned<Decorator>]) {
    ...
    pub fn validate_decorators_rejecting_user_defined(
        &mut self,
    ...
    pub fn validate_rust_allow_args(&mut self, dec: &Spanned<Decorator>) {
    ...
    pub fn reject_rust_allow_on_unsupported_declaration(
        &mut self,
        decorators: &[Spanned<Decorator>],
        kind: &'static str,
    ) {
    ...
    pub fn is_user_defined_decorator_candidate(&mut self, dec: &Decorator) -> bool {
    ...
    pub fn decorator_id(&self, dec: &Decorator) -> Option<DecoratorId> {
    ...
    pub fn validate_c_binding_class(&mut self, class: &ClassDecl) {
    ...
    pub fn validate_derives(&mut self, decorators: &[Spanned<Decorator>]) {
