...
pub(in crate::typechecker) fn classify_tuple_shape(ty: &ResolvedType) -> TupleShape {
    match ty {
...
impl TypeChecker {
    ...
    pub(in crate::typechecker) fn resolve_isinstance_target(
        &mut self,
        expr: &Spanned<Expr>,
    ...
    pub(in crate::typechecker) fn define_for_pattern_bindings(
        &mut self,
    ...
    fn infer_fallible_iterator_element_type_from_expr(
        ...
        let has_source_trait_dispatch = self
            .type_info
            .resolved_method_call(iter_expr.span)
            .is_some_and(|call| matches!(call.dispatch, crate::typechecker::ResolvedMethodDispatch::Trait { .. }));
