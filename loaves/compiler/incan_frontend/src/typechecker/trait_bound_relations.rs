...
impl TypeChecker {
    ...
    pub(in crate::typechecker) fn type_bound_display(
        &self,
        bound: &TypeBoundInfo,
    ...
    pub(in crate::typechecker) fn active_type_param_name<'a>(&self, ty: &'a ResolvedType) -> Option<&'a str> {
        let name = match ty {
    ...
    fn type_bound_implies_bound_info(
        ...
        let substitutions = crate::resolved_type_subst::type_param_subst_map(&active_trait.type_params, &active_args);
    ...
    fn type_implements_trait_with_args(
        ...
        let owner_subst = crate::resolved_type_subst::type_param_subst_map(owner_type_params, concrete_type_args);
    ...
    pub(in crate::typechecker) fn resolve_bound_trait_path(&self, bound: &str) -> Option<(Vec<String>, String)> {
    ...
    pub(in crate::typechecker) fn temporary_trait_capability_supports_type(
        &self,
        capability: &TraitCapabilityInfo,
        ty: &ResolvedType,
    ) -> Option<bool> {
    ...
    fn nominal_type_explicitly_adopts_temporary_capability(
        ...
        let substitutions = crate::resolved_type_subst::type_param_subst_map(owner_type_params, concrete_type_args);
    ...
    fn newtype_satisfies_string_try_from(
        ...
        let substitutions = crate::resolved_type_subst::type_param_subst_map(&info.type_params, type_args);
