...
use crate::api_metadata::CheckedApiMetadataPackage;
use crate::contract_metadata::ContractMetadataPackage as ModelContractMetadataPackage;
...
use crate::registry_metadata::CheckedRegistryMetadataPackage;
use crate::symbols::{
...
///
/// This is deliberately not a serialized [`crate::symbols::SymbolId`], whose integer value is local to one
...
impl TypeRef {
    ...
    pub fn has_native_union(&self) -> bool {
...
impl NativeUnionExport {
    ...
    pub fn for_publication(&self) -> Self {
...
impl NewtypeConstraintExport {
    ...
    pub fn from_checked(constraint: &NewtypePrimitiveConstraint) -> Self {
        let key = match constraint.key {
            crate::ast::TypeConstraintKey::Ge => NewtypeConstraintKeyExport::Ge,
            crate::ast::TypeConstraintKey::Gt => NewtypeConstraintKeyExport::Gt,
            crate::ast::TypeConstraintKey::Le => NewtypeConstraintKeyExport::Le,
            crate::ast::TypeConstraintKey::Lt => NewtypeConstraintKeyExport::Lt,
        };
        Self {
            key,
    ...
    pub fn to_checked(&self) -> NewtypePrimitiveConstraint {
        let key = match self.key {
            NewtypeConstraintKeyExport::Ge => crate::ast::TypeConstraintKey::Ge,
            NewtypeConstraintKeyExport::Gt => crate::ast::TypeConstraintKey::Gt,
            NewtypeConstraintKeyExport::Le => crate::ast::TypeConstraintKey::Le,
            NewtypeConstraintKeyExport::Lt => crate::ast::TypeConstraintKey::Lt,
        };
...
/// them.
pub fn param_default_from_checked(value: &CheckedParamDefault) -> Option<ParamDefaultExport> {
    match value {
...
pub fn params_from_checked(params: &[CallableParam], defaults: &[Option<CheckedParamDefault>]) -> Vec<ParamExport> {
    params
        .iter()
        .enumerate()
        .filter_map(|param| {
...
fn param_kind_from_ast(kind: crate::ast::ParamKind) -> ParamKindExport {
    match kind {
        crate::ast::ParamKind::Normal => ParamKindExport::Normal,
        crate::ast::ParamKind::RestPositional => ParamKindExport::RestPositional,
        crate::ast::ParamKind::RestKeyword => ParamKindExport::RestKeyword,
    }
}

/// Map a checked method receiver onto its manifest export form.
fn receiver_from_checked(receiver: Option<crate::ast::Receiver>) -> Option<ReceiverExport> {
...
fn method_from_checked(package_name: &str, method: &crate::library_exports::CheckedMethod) -> MethodExport {
    MethodExport {
...
fn field_from_checked(package_name: &str, field: &crate::library_exports::CheckedField) -> FieldExport {
    ...
    FieldExport {
        ...
        visibility: match field.visibility {
            crate::ast::Visibility::Private => FieldVisibilityExport::Private,
            crate::ast::Visibility::Public => FieldVisibilityExport::Public,
        },
