...
pub fn type_param_subst_map(params: &[String], args: &[ResolvedType]) -> HashMap<String, ResolvedType> {
    params
        .iter()
        .zip(args.iter())
...
pub fn type_param_subst_map_call_site(params: &[String], args: &[ResolvedType]) -> HashMap<String, ResolvedType> {
    params
        .iter()
        .zip(args.iter())
        .filter_map(|(p, a)| {
...
pub fn substitute_resolved_type(ty: &ResolvedType, map: &HashMap<String, ResolvedType>) -> ResolvedType {
    match ty {
...
pub fn substitute_property_info(info: &PropertyInfo, map: &HashMap<String, ResolvedType>) -> PropertyInfo {
    PropertyInfo {
...
pub fn substitute_method_info(info: &MethodInfo, map: &HashMap<String, ResolvedType>) -> MethodInfo {
    MethodInfo {
        identity: info.identity.clone(),
