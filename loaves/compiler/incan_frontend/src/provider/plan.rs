...
pub struct SdkDependencyRebinding {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SdkArtifactProjection {
...
#[derive(Debug, Clone)]
pub struct PublicProviderArtifact {
...
impl ProviderPlan {
    ...
    pub fn public_artifacts(&self) -> impl Iterator<Item = &PublicProviderArtifact> {
    ...
    pub fn public_nominal_projection(
        &self,
    ...
    /// artifact.
    pub fn public_native_union_projection(
        &self,
        importing_library: &str,
    ...
    pub fn public_nominal_declaration(
        &self,
        origin: &crate::library_manifest::NominalTypeOriginExport,
    ...
    pub fn declaring_public_provider(
        &self,
        importing_library: &str,
    ...
    pub fn sdk_dependency_rebindings(&self) -> &[SdkDependencyRebinding] {
    ...
    pub fn sdk_artifact_projections(&self) -> &[SdkArtifactProjection] {
