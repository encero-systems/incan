...
use oven_model::manifest::{ExpandedProjectFeature, LOAF_MANIFEST_FILENAME, ProjectFeatureDefinition, ProjectManifest};
...
pub fn feature_value_location(path: &Path, owner: Option<&str>, candidates: &[String]) -> String {
...
mod tests {
    ...
    fn manifest(content: &str) -> Result<ProjectManifest, oven_model::manifest::ManifestError> {
