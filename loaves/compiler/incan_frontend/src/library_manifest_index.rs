...
impl LibraryManifestIndex {
    ...
    pub fn rust_abi_item(&self, canonical_path: &str) -> Option<RustItemMetadata> {
    ...
    pub fn library_imported_vocab(&self) -> crate::parser::ImportedLibraryVocab {
        let mut map = HashMap::new();
    ...
    pub fn library_imported_dsl_surfaces(&self) -> crate::parser::ImportedLibraryDslSurfaces {
        let mut map = HashMap::new();
...
pub fn load_provider_dependency_artifact(dependency_key: &str, crate_root: &Path) -> LibraryManifestIndexEntry {
    load_library_manifest_entry_from_crate_root(dependency_key, crate_root)
}
