...
use incan_driver::backend::selection::ShadowComparisonState;
...
fn compare_without_direct_panic(
    ...
    capability: &incan_driver::backend::shadow::legacy_oven::LegacyOvenCapability,
    workspace: &Path,
...
-> Result<Option<incan_driver::backend::shadow::legacy_oven::LegacyOvenCapability>, Box<dyn std::error::Error>> {
