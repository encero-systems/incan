...
use crate::build::{INLINE_COMMAND_OUTPUT_PARENT, INLINE_COMMAND_PROJECT_PREFIX, InlineCommandProject};
...
pub fn inline_command_project(wrapped_source: &str) -> CliResult<InlineCommandProject> {
...
pub fn wrap_inline_command_source(source: &str) -> String {
