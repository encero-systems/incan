...
use oven_rustc::loaf::OVEN_LOAF_ENV;
...
pub fn prepare_shadow_legacy_materialization(
    entry_path: &Path,
...
fn canonical_oven_build_unit_inputs(
    ...
    crate::build_unit::oven_build_unit_inputs(provider_plan, &requirements, &resolved).map_err(|error| {
        ShadowUnavailable::new(format!(
