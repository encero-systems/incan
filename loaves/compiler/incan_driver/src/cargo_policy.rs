...
use oven_model::project_lifecycle::toolchain::ToolchainConstraintSet;
...
pub struct CargoPolicyCliFlags {
    pub offline: bool,
    pub no_offline: bool,
    pub locked: bool,
    pub no_locked: bool,
...
impl CargoPolicy {
    ...
    pub fn explicit(offline: bool, locked: bool, frozen: bool, extra_args: Vec<String>) -> Self {
        let mut policy = Self {
            offline,
            locked,
            frozen,
...
pub fn enforce_project_toolchain_constraint(manifest: &ProjectManifest) -> CliResult<()> {
...
pub fn cargo_policy_flags(policy: &CargoPolicy) -> Vec<String> {
    if policy.frozen {
...
pub fn cargo_lockfile_flags(policy: &CargoPolicy, cargo_features: &CargoFeatureSelection) -> Vec<String> {
...
pub fn cargo_command_flags(policy: &CargoPolicy, cargo_features: &CargoFeatureSelection) -> Vec<String> {
