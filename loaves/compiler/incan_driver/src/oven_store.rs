...
impl OvenStoreCommandOptions {
    ...
    pub fn is_ordinary_default(&self) -> bool {
        self.root.is_none()
...
pub fn open_store(options: &OvenStoreCommandOptions) -> CliResult<OvenStore> {
...
pub fn open_store_with_defaults(options: &OvenStoreCommandOptions, defaults: OvenStoreLimits) -> CliResult<OvenStore> {
...
pub fn open_default_oven_store() -> CliResult<OvenStore> {
...
pub fn resolve_limits_with_environment_and_defaults(
    options: &OvenStoreCommandOptions,
...
pub fn parse_limit_value(name: &str, value: Option<String>, default: u64) -> CliResult<u64> {
    match value {
...
pub fn default_store_root(incan_home: Option<OsString>, home: Option<OsString>) -> Option<PathBuf> {
    incan_home
        ...
        .map(|root| oven_store::store::store_root_for_home(&root))
}
