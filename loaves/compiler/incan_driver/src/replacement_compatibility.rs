...
use incan_frontend::feature_metadata::{PublicFeatureDescriptor, public_feature_descriptors};
...
#[derive(Debug, Clone)]
pub struct ReplacementCompatibilityContribution {
    pub source: CompatibilityRegistrationSource,
...
/// `loaves/stdlib/core/src/features.incn`. Future public-registry edits therefore cannot alter or invalidate this
/// released compatibility target. Descriptor field extraction still goes through the shared checked metadata path
/// rather than a hand-maintained Rust list.
...
fn frozen_v0_5_capabilities_snapshot_path() -> PathBuf {
    oven_model::toolchain_layout::development_root().join(FROZEN_V0_5_CAPABILITIES_PATH)
}
...
pub fn local_implementation_contribution(
    id: &'static str,
...
///
/// Each parameter is a distinct named field of the record being built, so grouping them into a struct would only move
/// the same list behind another type.
...
fn registry_workspace_root() -> Result<PathBuf, RegistryValidationError> {
    ...
    let manifest_root = oven_model::toolchain_layout::development_root();
    ...
    local_implementation_contribution(
        ...
        vec![
            planned_feature_at_boundary(
                ...
                "loaves/compiler/incan_frontend/src/typechecker/check_expr/calls.rs",
                "fn check_call",
                "fn lower_call",
                "fn execute_call",
            ),
...
fn replacement_compatibility_direct_execution_contribution() -> ReplacementCompatibilityContribution {
    let mut async_tasks = preserved_feature_at_boundary(
        ...
        "loaves/compiler/incan_frontend/src/typechecker/check_expr/control_flow.rs",
        "fn check_await",
        "fn lower_race_for",
        "fn execute_race",
    );
    ...
    local_implementation_contribution(
        ...
        vec![
            ...
            preserved_feature_at_boundary(
                ...
                "loaves/compiler/incan_frontend/src/typechecker/check_expr/ops.rs",
                "fn check_binary",
                "fn lower_binary",
                "fn evaluate_binary",
            ),
            partially_materialized_feature_at_boundary(
                ...
                "loaves/compiler/incan_frontend/src/typechecker/check_stmt.rs",
                "fn check_assignment",
                "loaves/compiler/incan_frontend/src/body_ir/primitives.rs",
...
fn feature_anchor_profile(feature_id: &str) -> FeatureAnchorProfile {
    match feature_id {
        "call.named-and-variadic" | "call.partial-binding" | "call.stored-callables" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_expr/calls.rs",
        ...
        "decorators.dsl-surfaces" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/collect/decorators.rs",
        ...
        "diagnostics.stable" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_stmt.rs",
        ...
        "error.result-and-try" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_expr/control_flow.rs",
        ...
        "iteration.protocol-and-adapters" | "iteration.user-and-fallible" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_expr/ops.rs",
        ...
        "language.aggregates-and-projections" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_expr/collections.rs",
        ...
        "language.match-and-patterns" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_expr/match_.rs",
        ...
        "module.identity-and-aliases" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/collect/stdlib_imports.rs",
            typechecker_selector: "fn collect_import",
            body_ir_selector: "fn lower_call",
            replacement_executor_selector: "fn execute_call",
        },
        "nominal.models-unions-enums" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_decl.rs",
        ...
        "runtime.std-data-services" | "runtime.std-hosted-services" | "runtime.std-observability" => {
            FeatureAnchorProfile {
                typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/stdlib_loader.rs",
        ...
        "types.traits-generics-reflection" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/trait_bound_relations.rs",
            typechecker_selector: "fn type_satisfies_explicit_bound",
            body_ir_selector: "fn lower_call",
            replacement_executor_selector: "fn execute_call",
        },
        "interop.rust-and-c" => FeatureAnchorProfile {
            typechecker_path: "loaves/compiler/incan_frontend/src/typechecker/check_expr/calls/rust_boundary.rs",
...
#[allow(clippy::too_many_arguments)]
pub fn planned_feature_at_boundary(
    id: &'static str,
    contract: &'static str,
    owner_issue: u32,
    blocker: &'static str,
        ...
        evidence: CompatibilityEvidence {
            ...
            surfaces: FeatureSurfaceCoverage {
                ...
                body_ir: planned_anchor(
                    EvidenceSurface::BodyIr,
                    "loaves/compiler/incan_frontend/src/body_ir.rs",
                    profile.body_ir_selector,
                    owner_issue,
                ...
                replacement_executor: planned_anchor(
                    EvidenceSurface::ReplacementExecutor,
                    "loaves/compiler/incan_emit/src/replacement/mod.rs",
                    profile.replacement_executor_selector,
                    owner_issue,
...
#[allow(clippy::too_many_arguments)]
pub fn partially_materialized_feature_at_boundary(
    id: &'static str,
    contract: &'static str,
    owner_issue: u32,
    blocker: &'static str,
...
pub fn preserved_feature_at_boundary(
    id: &'static str,
    contract: &'static str,
    typechecker_path: &'static str,
    typechecker_selector: &'static str,
...
pub fn feature_requirement_link(feature_id: &'static str, requirement_id: &'static str) -> FeatureRequirementLink {
...
mod tests {
    ...
    -> Result<(), Box<dyn std::error::Error>> {
        ...
        let migration_baseline_readme = fs::read_to_string(
            root.join("loaves/compiler/incan_driver/src/replacement_compatibility/migration_baselines/README.md"),
        )?;
