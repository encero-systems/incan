...
//!
//! This is the primary struct for generating inspectable Rust projections from Incan code. Its responsibilities are
...
pub use oven_model::toolchain_layout::GENERATED_CARGO_TARGET_DIR_ENV;

/// Hash Cargo configuration files visible from one project without making their absolute roots part of the identity.
pub fn cargo_config_identity(start: &Path) -> String {
...
pub(crate) fn is_sdk_provider_build() -> bool {
...
pub struct ProjectGenerator {
    ...
    pub(crate) dev_dependencies: Vec<DependencySpec>,
...
impl ProjectGenerator {
    ...
    pub fn set_public_namespace_facades(&mut self, api: &incan_frontend::api_metadata::CheckedApiMetadataPackage) {
            ...
            api.public_namespaces
                ...
                .map(|namespace| {
                    let parent_names = api
                        ...
                        .filter_map(incan_frontend::api_metadata::api_declaration_public_name)
                        .collect::<BTreeSet<_>>();
                    let children = namespace
                        ...
                        .filter(|child| {
                            ...
                            api.modules
                                ...
                                .flat_map(|module| &module.declarations)
                                .filter(|declaration| {
                                    incan_frontend::api_metadata::checked_api_declaration_is_public_namespace_member(
                                        declaration,
                                    )
                                })
                                .filter_map(incan_frontend::api_metadata::api_declaration_public_name)
    ...
    pub(crate) fn cargo_package_name(&self) -> &str {
    ...
    /// artifact.
    pub fn enable_companion_library_target(&mut self) {
    ...
    pub(crate) fn cargo_lock_projection(&self) -> io::Result<Option<super::lock_projection::CargoLockProjection>> {
    ...
    #[cfg(feature = "cli")]
    pub fn set_generated_cache_context(&mut self, lease: Option<GeneratedCacheLease>, identity: Option<String>) {
        *self
    ...
    pub(crate) fn finish_generated_cache_lease(&self) -> io::Result<()> {
        let lease = self
            .generated_cache_lease
            .write()
    ...
    #[cfg(test)]
    pub(crate) fn generated_cache_identity(&self) -> Option<&str> {
        #[cfg(feature = "cli")]
        {
    ...
    pub fn set_provider_plan(&mut self, plan: &ProviderPlan) {
    ...
    pub fn set_sdk_dependency_rebindings(&mut self, rebindings: Vec<SdkDependencyRebinding>) {
    ...
    pub fn set_sdk_path_dependencies(&mut self, dependencies: Vec<DependencySpec>) {
    ...
    pub fn set_sdk_artifact_projections(&mut self, projections: Vec<SdkArtifactProjection>) {
    ...
    pub fn effective_dependencies(&self) -> io::Result<Vec<DependencySpec>> {
    ...
    /// target lifecycle.
    pub(crate) fn generated_cargo_target_dir_override() -> Option<PathBuf> {
    ...
    pub(crate) fn cargo_target_dir_override(&self) -> Option<PathBuf> {
    ...
    pub(crate) fn resolve_target_dir(target_dir: PathBuf) -> PathBuf {
    ...
    pub fn rust_target_name(name: &str) -> String {
    ...
    pub(crate) fn cargo_target_name(&self) -> String {
    ...
    pub(crate) fn shared_target_safe_name(name: &str, root_identity: &str) -> String {
    ...
    fn discard_lock_superseded_by_its_manifest(&self, lock_path: &Path, manifest: &str) -> io::Result<bool> {
        ...
        let expected = oven_store::digest_bytes(manifest.as_bytes());
...
mod tests {
    use super::*;
    use incan_frontend::library_manifest::{ProviderDependencyMetadata, ProviderModuleClaim};
    use incan_frontend::library_manifest_index::LibraryArtifactMetadata;
    use incan_provider::{SdkArtifactProjection, SdkDependencyRebinding};
    ...
    fn compile_rebound_fixture_with_rustc(
        ...
        let rustc = std::env::var_os(oven_store::compiler_suite_env::OVEN_COMPILER_SUITE_RUSTC_ENV)
