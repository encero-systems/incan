...
impl ProjectGenerator {
    ...
    pub fn materialize_cargo_lock_projection(&self) -> io::Result<bool> {
...
/// `path+file:///…/name#0.1.0` when the name is the last path segment); older releases spelled it `name version
/// (source)`.
#[cfg(test)]
