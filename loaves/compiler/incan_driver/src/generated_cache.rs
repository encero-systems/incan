...
pub const GENERATED_CACHE_MAX_BYTES_ENV: &str = "INCAN_GENERATED_CACHE_MAX_BYTES";
pub const GENERATED_CACHE_MAX_ENTRY_BYTES_ENV: &str = "INCAN_GENERATED_CACHE_MAX_ENTRY_BYTES";
pub const GENERATED_CACHE_ENABLED_ENV: &str = "INCAN_GENERATED_CACHE";
...
pub struct GeneratedCargoTarget {
    path: PathBuf,
...
pub struct GeneratedCacheEntry {
    pub category: String,
    pub identity: String,
    pub path: PathBuf,
    pub bytes: u64,
...
#[derive(Debug, Clone, Serialize)]
pub struct GeneratedCacheInspection {
    pub schema_version: u32,
    pub root: PathBuf,
    pub max_bytes: u64,
    pub total_bytes: u64,
    pub entries: Vec<GeneratedCacheEntry>,
}

/// Result of a generated-cache prune operation.
#[derive(Debug, Clone, Serialize)]
pub struct GeneratedCachePruneReport {
    pub schema_version: u32,
    pub root: PathBuf,
    pub max_bytes: u64,
    ...
    pub requested_identities: Vec<String>,
    pub not_found_identities: Vec<String>,
    pub dry_run: bool,
}

/// Resolve an explicit target override or acquire the default managed compatibility-domain target.
#[allow(clippy::too_many_arguments)]
pub fn resolve_generated_cargo_target(
...
#[cfg(all(any(test, feature = "test_support"), feature = "rust_inspect"))]
#[allow(dead_code)] // The LSP-only resolver is exercised by feature-gated integration fixtures.
#[allow(clippy::too_many_arguments)]
pub fn resolve_generated_cargo_target_in_cache_root(
    cache_root: &Path,
    cargo_working_dir: &Path,
    generated_package_name: &str,
    profile: &str,
...
pub fn inspect_default_cache() -> io::Result<GeneratedCacheInspection> {
