...
impl<'a> Lexer<'a> {
    /// Process a text escape sequence (for strings and f-strings). Called after consuming the backslash.
    ...
    /// Process a byte escape sequence. Called after consuming the backslash.
