...
//!
//! Syntax-level errors raised during lexing and parsing, before type checking begins. These typically use
//! [`ErrorKind::Syntax`](crate::diagnostics::ErrorKind::Syntax).
