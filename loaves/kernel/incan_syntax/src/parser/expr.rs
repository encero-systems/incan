...
impl<'a> Parser<'a> {
    ...
    /// Parse slice syntax after optional start expression start is already parsed, now parse [:end[:step]]
    ...
    /// Convert expressions to closure parameters Only identifiers are valid as closure params
