...
///
/// Most functions in this file are internal (`fn`) and are documented primarily to aid maintenance and onboarding.
impl<'a> Parser<'a> {
    // ========================================================================
    // Helpers
    // ========================================================================
    ...
    ///
    /// This keeps the parser tolerant of source that the formatter will normalize, such as: `elif cond:` followed by
    /// one blank line before the first body statement.
    ///
