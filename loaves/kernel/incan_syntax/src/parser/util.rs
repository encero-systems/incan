...
///
/// This chunk contains small shared parsing helpers that don’t cleanly fit into “decl”, “stmt”, “expr”, or “types”
/// (e.g. identifier parsing and string literal handling).
impl<'a> Parser<'a> {
    // ========================================================================
    // Utilities
    // ========================================================================
