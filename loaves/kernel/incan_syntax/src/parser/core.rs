...
///
/// This chunk defines the [`Parser`] type and its top-level `parse()` entrypoint. It also contains a few small internal
/// helper types shared across the other parser chunks.
///
/// ## Notes
