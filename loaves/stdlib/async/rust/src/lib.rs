//! Task, timer, channel and synchronization runtime: the Rust facet of the `async` standard library component.
//!
...
//! spawning and joining, timeouts, racing, channels and the synchronization primitives.
