...
pub(crate) fn compiler_suite_environment(
    ...
    sdk_inventory: &Path,
    rustc: &Path,
    warning_check_artifacts: &oven_rustc::rustc::OvenRustcArtifactPlan,
...
pub(crate) fn compiler_suite_environment_with_vocab(
    ...
    rustc: &Path,
    warning_check_artifacts: &oven_rustc::rustc::OvenRustcArtifactPlan,
    vocab_extraction_artifacts: &oven_rustc::rustc::OvenRustcArtifactPlan,
    compiler_data_root: Option<&Path>,
    output_directory: &Path,
) -> CliResult<BTreeMap<String, String>> {
...
pub(crate) fn append_compiler_suite_direct_rustc_environment(
    ...
    variable: &str,
    rustc: &Path,
    artifacts: &oven_rustc::rustc::OvenRustcArtifactPlan,
) -> CliResult<()> {
