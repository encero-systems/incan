...
//! [`incan_driver::inspect::codegraph`], behind the compiler boundary, so one rule cannot end up with two
...
use incan_driver::inspect::codegraph::{collect_codegraph_records, normalize_input_path};
