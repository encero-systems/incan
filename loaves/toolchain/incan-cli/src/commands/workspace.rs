...
//!
//! This command is intentionally a thin projection over [`oven_model::workspace::WorkspaceGraph`]. It must never
...
fn inspection_report(
    ...
    selection: &oven_model::workspace::WorkspaceSelection<'_>,
    current_dir: &Path,
...
fn unused_shared_dependency_warnings(
    shared: &oven_model::manifest::WorkspaceSharedDependencies,
...
fn scope_origin_name(origin: oven_model::workspace::WorkspaceScopeOrigin) -> &'static str {
    match origin {
        oven_model::workspace::WorkspaceScopeOrigin::CurrentMember => "current_member",
        oven_model::workspace::WorkspaceScopeOrigin::DefaultMembers => "default_members",
        oven_model::workspace::WorkspaceScopeOrigin::ImplicitRootMember => "implicit_root_member",
        oven_model::workspace::WorkspaceScopeOrigin::Workspace => "workspace",
        oven_model::workspace::WorkspaceScopeOrigin::ExplicitMembers => "explicit_members",
    }
}
...
mod tests {
    ...
    use oven_model::workspace::{WorkspaceGraph, WorkspaceScopeOrigin, WorkspaceScopeRequest};
