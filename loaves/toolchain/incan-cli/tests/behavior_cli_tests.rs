//! The `cli` area of the behavior-fixture family: twins of the retire-class tests under `loaves/toolchain/incan-cli`.
//!
...
//! generated Rust after a build or a codegen call; these fixtures prove the same program's observable behavior by
