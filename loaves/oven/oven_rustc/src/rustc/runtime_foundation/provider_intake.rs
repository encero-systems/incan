...
pub const OVEN_RUNTIME_FOUNDATION_PROVIDER_INTAKE_REQUEST_SCHEMA: &str =
    "incan.oven.runtime-foundation-provider-intake-request/2";
pub(crate) const OVEN_RUNTIME_FOUNDATION_PROVIDER_INTAKE_SCHEMA: &str =
...
pub struct OvenRuntimeFoundationProviderIntakeHostDependency {
...
#[derive(Debug, Clone)]
pub struct OvenRuntimeFoundationProviderIntakeEvidence {
    ...
    pub(crate) package: OvenRuntimeFoundationProviderPackageSource,
...
pub(crate) fn seal_runtime_foundation_provider_receipts(
...
pub(crate) fn runtime_foundation_provider_effect_digest(
...
pub(crate) fn runtime_foundation_provider_receipt_identity(
...
pub(crate) fn parse_runtime_foundation_provider_directives(
    stdout: &[u8],
...
pub(crate) fn bind_runtime_foundation_provider_directives(
...
pub fn encode_runtime_foundation_provider_intake_request(
    selected: &ValidatedOvenSelectedRustFacetGraph,
...
pub fn decode_runtime_foundation_provider_intake(
    selected: &ValidatedOvenSelectedRustFacetGraph,
    evidence: &OvenRuntimeFoundationProviderIntakeEvidence,
    response: &[u8],
