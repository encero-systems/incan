...
pub enum OvenNativeInputOrigin<'facts> {
    ...
    ToolchainLoaf {
        ...
        member: &'facts crate::loaf::OvenLoafEnvelopeMember,
    },
}
...
enum OvenNativeInputOwner<'owner> {
    ...
    ToolchainLoaf(&'owner crate::loaf::OvenMaterializedLoafCandidate<'owner>),
}
...
impl OvenStoredDirectRustcExecutionPlan {
    ...
    pub fn from_execution_payload(owner: OvenStoreExecutionPayload) -> Result<Self, OvenRustcError> {
    ...
    pub fn native_input_view(&self) -> Result<OvenNativeInputView<'_>, OvenRustcError> {
...
pub struct OvenNativeInputView<'owner> {
    owner: OvenNativeInputOwner<'owner>,
    pub(crate) artifacts: Cow<'owner, OvenRustcArtifactManifest>,
    artifact_root: PathBuf,
    pub(crate) plan: Cow<'owner, OvenRustcArtifactPlan>,
}
...
impl<'owner> OvenNativeInputView<'owner> {
    ...
    pub fn from_store_payload(owner: &'owner OvenStoreExecutionPayload) -> Result<Self, OvenRustcError> {
        if owner.manifest.kind != OvenArtifactKind::DirectRustcPlan {
            return Err(OvenRustcError::InvalidInput {
    ...
    pub fn from_materialized_loaf(
        owner: &'owner crate::loaf::OvenMaterializedLoafCandidate<'owner>,
    ...
    pub fn origin(&self) -> OvenNativeInputOrigin<'_> {
        match &self.owner {
    ...
    pub fn receipt_identity(&self) -> Option<&str> {
        match self.origin() {
    ...
    /// facts.
    pub fn original_native_receipt(&self) -> Result<&OvenReceipt, OvenRustcError> {
    ...
    pub fn build_unit_identity(&self) -> &str {
        match self.origin() {
    ...
    pub fn intent(&self) -> &OvenBuildIntent {
    ...
    pub fn registry_candidates(&self, source_role: &str) -> Result<Vec<OvenNativeInputCandidate<'_>>, OvenRustcError> {
    ...
    pub fn named_candidates(&self, source_role: &str) -> Result<Vec<OvenNativeInputCandidate<'_>>, OvenRustcError> {
        self.require_original_role(source_role)?;
...
#[derive(Clone)]
pub struct OvenNativeInputCandidate<'view> {
...
pub struct OvenSelectedNativeInput<'view> {
...
pub struct OvenSelectedNativeSourcePlan<'owner> {
