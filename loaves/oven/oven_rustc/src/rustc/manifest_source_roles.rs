...
impl OvenRustcArtifactManifest {
    ...
    pub fn named_artifacts_for_source_role(
        &self,
        source_role: &str,
    ...
    pub(crate) fn validate_source_search_roles(&self) -> Result<(), OvenRustcError> {
    ...
    pub(crate) fn role_binds_crate_elsewhere(&self, key: &str, relative_path: &str) -> bool {
    ...
    pub(crate) fn bind_source_search_roles(
        &self,
    ...
    pub(crate) fn source_search_roles_at_root(
        &self,
        root: &Path,
    ) -> Result<Option<OvenRustcSourcePathProjection>, OvenRustcError> {
    ...
    pub(crate) fn for_source_evidence(&self, source_evidence_key: &str) -> Result<Self, OvenRustcError> {
