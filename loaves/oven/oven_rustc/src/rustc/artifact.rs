...
impl OvenRustcSourceSearchClosure {
    ...
    pub fn publisher_selected(paths: Vec<String>, declared: &BTreeMap<String, String>) -> Self {
        Self {
    ...
    pub fn directories(&self) -> impl Iterator<Item = &OvenRustcSourceSearchDirectory> {
...
pub struct OvenRustcArtifactPlan {
    ...
    pub source_path_projection: Option<OvenRustcSourcePathProjection>,
    ...
    pub caller_owned_library_digests: BTreeMap<String, String>,
}
...
impl OvenRustcArtifactPlan {
    ...
    pub fn retain_caller_dependency_search_path(&mut self, path: PathBuf) {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct OvenRustcSourcePathProjection {
    ...
    pub roles: BTreeMap<String, (OvenRustcSourceSearchClosure, BTreeSet<PathBuf>)>,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct OvenRustcArtifactPartition {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct OvenCallerOwnedRustcLibrary {
