...
use crate::rustc::OvenRustcArtifactPlan;
...
pub struct OvenNativeLoafCandidates {
...
impl OvenNativeLoafCandidates {
    ...
    pub fn from_committed_envelope(root: &Path, envelope: OvenLoafEnvelope) -> Result<Option<Self>, OvenLoafError> {
    ...
    pub fn candidates(&self) -> impl Iterator<Item = OvenNativeLoafCandidate<'_>> {
...
#[derive(Clone, Copy)]
pub struct OvenNativeLoafCandidate<'owner> {
...
impl<'owner> OvenNativeLoafCandidate<'owner> {
    ...
    pub fn member(&self) -> &'owner OvenLoafEnvelopeMember {
    ...
    pub fn materialize(self) -> Result<OvenMaterializedLoafCandidate<'owner>, OvenLoafError> {
...
pub struct OvenMaterializedLoafCandidate<'owner> {
...
impl OvenMaterializedLoafCandidate<'_> {
    ...
    pub fn candidate(&self) -> OvenNativeLoafCandidate<'_> {
        self.candidate
    }
