...
pub fn read_legacy_cargo_metadata(
    cargo: &Path,
    cargo_manifest: &Path,
    features: &[String],
...
pub fn read_legacy_cargo_metadata_with_lock_policy(
    cargo: &Path,
    cargo_manifest: &Path,
    features: &[String],
...
pub fn read_legacy_cargo_metadata_for_platform(
    cargo: &Path,
    cargo_manifest: &Path,
    features: &[String],
    require_existing_lock: bool,
...
pub fn resolve_direct_dependency_packages(
...
pub fn project_registry_source_dependencies(
    metadata: &CargoMetadata,
    dependencies: &BTreeMap<String, String>,
...
pub fn verified_release_cohort_registry_lock(
...
pub fn legacy_cargo_inspection_sources_from_metadata(
    metadata: &CargoMetadata,
    cargo_lock: &[u8],
    inspection_packages: &[OvenLegacyCargoInspectionPackage],
...
pub fn fold_repeated_inspection_sources(
