...
pub fn parse_compiler_suite_unit_graph(output: &CargoInvocationOutput) -> Result<CargoUnitGraph, OvenLegacyCargoError> {
...
pub fn validate_compiler_suite_unit_graph(
    compiler_root: &Path,
...
#[cfg(test)]
pub fn compiler_suite_target_selections(
    compiler_root: &Path,
    graph: &CargoUnitGraph,
...
#[cfg(test)]
pub fn compiler_suite_target_selection_groups(
    compiler_root: &Path,
    graph: &CargoUnitGraph,
...
#[cfg(test)]
pub fn compiler_suite_target_selection_for_unit(
    compiler_root: &Path,
...
pub fn compiler_suite_package_name_for_source(
    compiler_root: &Path,
    source: &Path,
...
pub struct CompilerSuiteArtifactCatalog {
    pub closure: OvenCompilerTestSuiteArtifactClosure,
    pub materialized_files: Vec<OvenArtifactMaterializedFile>,
    pub by_source_path: BTreeMap<PathBuf, (String, String)>,
}
...
#[cfg(test)]
pub struct CompilerSuiteTargetPlanCoverage {
    pub targets: Vec<OvenCompilerTestSuiteTarget>,
...
pub fn compiler_suite_artifact_catalog(
    staging: &Path,
...
pub fn compiler_suite_dependency_directories(target_deps: PathBuf, host_deps: PathBuf) -> Vec<PathBuf> {
...
pub fn insert_compiler_suite_catalog_artifact(
    staging: &Path,
...
pub fn compiler_suite_artifact_index(
...
pub fn compiler_suite_output_artifact_paths(
    output: &CargoInvocationOutput,
...
pub fn compiler_artifact_platform(path: &Path, target_triple: &str) -> Option<String> {
    path.components()
...
pub fn cargo_unit_artifact_key(unit: &CargoUnitGraphUnit) -> Result<CargoUnitArtifactKey, OvenLegacyCargoError> {
...
pub fn compiler_suite_dependency_artifact(
    unit: &CargoUnitGraphUnit,
...
pub fn compiler_suite_catalog_target_library(
    unit: &CargoUnitGraphUnit,
    catalog: &CompilerSuiteArtifactCatalog,
    crate_name: &str,
...
pub fn compiler_suite_workspace_library_key(
    compiler_root: &Path,
    unit: &CargoUnitGraphUnit,
...
pub fn compiler_suite_insert_extern(
...
pub fn compiler_suite_collect_transitive_proc_macro_externs(
    unit: &CargoUnitGraphUnit,
    graph: &CargoUnitGraph,
    compiler_root: &Path,
    artifact_index: &BTreeMap<CargoUnitArtifactKey, Vec<PathBuf>>,
...
pub fn compiler_suite_target_externs(
    unit: &CargoUnitGraphUnit,
    graph: &CargoUnitGraph,
    compiler_root: &Path,
    artifact_index: &BTreeMap<CargoUnitArtifactKey, Vec<PathBuf>>,
