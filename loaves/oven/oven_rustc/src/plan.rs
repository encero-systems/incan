...
pub type OvenPlanResult<T> = Result<T, OvenPlanError>;
...
#[derive(Clone, Copy)]
pub struct PackagedProviderCandidate<'a> {
    ...
    pub entries: &'a [OvenPackagedLibraryLoafEntry],
}

/// One immutable store entry transported by a public library package.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct OvenPackagedLibraryLoafEntry {
...
pub enum OvenDirectRustcPlanSelection {
...
impl OvenDirectRustcPlanSelection {
    ...
    pub fn report_identity(&self) -> String {
        match self {
    ...
    pub fn package_entries(&self, receipt: &OvenReceipt) -> Vec<OvenPackagedLibraryLoafEntry> {
        match self {
    ...
    pub fn source_artifact_plan(&self, source_evidence_key: &str) -> Result<OvenRustcArtifactPlan, OvenRustcError> {
        let mut plan =
    ...
    pub fn output_guard_root(&self) -> &Path {
        match self {
    ...
    pub fn uses_packaged_provider_closure(&self) -> bool {
    ...
    pub fn seals_current_project_path_dependencies(&self) -> bool {
    ...
    pub fn vocab_artifact_root(&self) -> Option<&Path> {
        match self {
    ...
    pub fn registry_leaf_authority(&self) -> Option<OvenRegistryLeafAuthority> {
        match self {
...
pub struct OvenStoredDirectRustcExecutionPlan {
    pub identity: String,
...
pub struct OvenStoredProjectExtensionExecutionPlan {
    pub identity: String,
    pub artifact_root: PathBuf,
    pub receipt: OvenReceipt,
...
pub struct OvenProjectExtensionExecutionPlan {
    pub base: OvenToolchainLoaf,
    pub extension: OvenStoredProjectExtensionExecutionPlan,
    pub artifacts: OvenRustcArtifactManifest,
    pub artifact_plan: OvenRustcArtifactPlan,
...
pub struct OvenPackagedProviderFragment {
...
pub struct OvenExtensionPackagedProviderExecutionPlan {
...
pub struct OvenPackagedDirectProviderFragment {
    dependency_key: String,
    receipt: OvenReceipt,
    identity: String,
...
pub struct OvenDirectPackagedProviderExecutionPlan {
...
pub enum OvenPackagedProviderExecutionPlan {
...
impl OvenPackagedProviderExecutionPlan {
    ...
    pub fn package_entries(&self) -> Vec<OvenPackagedLibraryLoafEntry> {
        match self {
...
pub mod test_support {
    ...
    use crate::rustc::{OvenRustcArtifactExtern, OvenRustcArtifactManifest};

    /// A two-extern package manifest whose closure is recaptured so `validate_shape` accepts it.
    pub fn package_loaf_manifest(
    ...
    pub fn recapture_package_loaf_closure(manifest: &mut OvenRustcArtifactManifest) {
        let closure = crate::rustc::OvenRustcSourceSearchClosure::publisher_selected(
