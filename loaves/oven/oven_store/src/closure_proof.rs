...
impl OvenClosureProof {
    ...
    pub fn path(proof_root: &Path, closure_identity: &str) -> PathBuf {
        proof_root
    ...
    pub fn read_matching(path: &Path, closure_identity: &str, artifact_count: u64) -> Option<Self> {
